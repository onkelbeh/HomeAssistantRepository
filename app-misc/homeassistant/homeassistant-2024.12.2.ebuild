...
# Home Assistant Core dependencies from ./homeassistant-2024.12.2/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20241127.7[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./core-2024.12.2/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	decora? ( ~dev-python/bluetooth-adapters-0.20.2[${PYTHON_USEDEP}] ~dev-python/deebot-client-9.3.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-9.3.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-9.3.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
