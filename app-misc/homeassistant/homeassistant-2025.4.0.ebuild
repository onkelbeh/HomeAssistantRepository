...
# Home Assistant Core dependencies from ./core-2025.4.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
# Home Assistant Core dependencies from ./homeassistant-2025.4.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	airzone_cloud? ( ~dev-python/aioairzone-cloud-0.6.11[${PYTHON_USEDEP}] )
	...
	bluetooth? ( ~dev-python/bleak-retry-connector-3.9.0[${PYTHON_USEDEP}] ~dev-python/bleak-0.22.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.4.5[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.26.5[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.43.0[${PYTHON_USEDEP}] ~dev-python/habluetooth-3.37.0[${PYTHON_USEDEP}] )
	bluetooth_tracker? ( ~dev-python/pychromecast-14.0.7[${PYTHON_USEDEP}] ~dev-python/bt-proximity-0.2.1[${PYTHON_USEDEP}] )
	bmw_connected_drive? ( ~dev-python/bimmer-connected-0.17.2[china,${PYTHON_USEDEP}] )
	bond? ( ~dev-python/bond-async-0.2.1[${PYTHON_USEDEP}] )
	bosch_alarm? ( ~dev-python/bosch-alarm-mode2-0.4.3[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.94.0[${PYTHON_USEDEP}] )
	...
	comelit? ( ~dev-python/aiocomelit-0.11.3[${PYTHON_USEDEP}] )
	...
	conversation? ( ~dev-python/hassil-2.2.3[${PYTHON_USEDEP}] ~dev-python/home-assistant-intents-2025.3.28[${PYTHON_USEDEP}] )
	...
	cups? ( ~dev-python/pydaikin-2.14.1[${PYTHON_USEDEP}] )
	daikin? ( ~dev-python/pydaikin-2.14.1[${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/deebot-client-12.5.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-12.5.0[${PYTHON_USEDEP}] )
	...
	dhcp? ( ~dev-python/aiodhcpwatcher-1.1.1[${PYTHON_USEDEP}] ~dev-python/aiodiscover-2.6.1[${PYTHON_USEDEP}] ~dev-python/cached-ipaddress-0.10.0[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.44.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-12.5.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/bleak-esphome-2.12.0[${PYTHON_USEDEP}] ~dev-python/eq3btsmart-1.4.1[${PYTHON_USEDEP}] )
	escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
	esphome? ( ~dev-python/aioesphomeapi-29.8.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.12.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] )
	...
	frontend? ( ~dev-python/home-assistant-frontend-20250401.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-7.0.0[${PYTHON_USEDEP}] ~dev-python/ical-9.0.3[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	...
	heos? ( ~dev-python/pyheos-1.0.4[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.69[${PYTHON_USEDEP}] )
	homeassistant_hardware? ( ~dev-python/ha-silabs-firmware-client-0.2.0[${PYTHON_USEDEP}] ~dev-python/universal-silabs-flasher-0.0.30[${PYTHON_USEDEP}] )
	home_connect? ( ~dev-python/aiohomeconnect-0.16.3[${PYTHON_USEDEP}] )
	homee? ( ~dev-python/pyHomee-1.2.8[${PYTHON_USEDEP}] )
	homekit_controller? ( ~dev-python/aiohomekit-3.2.13[${PYTHON_USEDEP}] )
	homekit? ( ~dev-python/HAP-python-4.9.2[${PYTHON_USEDEP}] ~dev-python/pyqrcode-1.2.1[${PYTHON_USEDEP}] ~dev-python/base36-0.1.1[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.4.0[${PYTHON_USEDEP}] )
	...
	husqvarna_automower? ( ~dev-python/aioautomower-2025.3.2[${PYTHON_USEDEP}] )
	...
	iaqualink? ( ~dev-python/h2-4.1.0[${PYTHON_USEDEP}] ~dev-python/iaqualink-0.5.3[${PYTHON_USEDEP}] )
	...
	isy994? ( ~dev-python/pyisy-3.1.15[${PYTHON_USEDEP}] )
	...
	jewish_calendar? ( ~dev-python/hdate-1.0.3[astral,${PYTHON_USEDEP}] )
	...
	ld2410_ble? ( ~dev-python/bluetooth-data-tools-1.26.5[${PYTHON_USEDEP}] ~dev-python/ld2410-ble-0.1.1[${PYTHON_USEDEP}] )
	leaone? ( ~dev-python/leaone-ble-0.1.0[${PYTHON_USEDEP}] )
	led_ble? ( ~dev-python/bluetooth-data-tools-1.26.5[${PYTHON_USEDEP}] ~dev-python/led-ble-1.1.6[${PYTHON_USEDEP}] )
	...
	linkplay? ( ~dev-python/python-linkplay-0.2.2[${PYTHON_USEDEP}] )
	...
	local_calendar? ( ~dev-python/ical-9.0.3[${PYTHON_USEDEP}] )
	local_todo? ( ~dev-python/ical-9.0.3[${PYTHON_USEDEP}] )
	...
	mcp_server? ( ~dev-python/aiohttp_sse-2.2.0[${PYTHON_USEDEP}] ~dev-python/anyio-4.9.0[${PYTHON_USEDEP}] ~dev-python/mcp-1.5.0[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2025.03.26[default,${PYTHON_USEDEP}] )
	...
	nexia? ( ~dev-python/nexia-2.4.0[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.16.5[${PYTHON_USEDEP}] )
	...
	private_ble_device? ( ~dev-python/bluetooth-data-tools-1.26.5[${PYTHON_USEDEP}] )
	...
	recorder? ( ~dev-python/sqlalchemy-2.0.39[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.4.0[${PYTHON_USEDEP}] ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] )
	...
	remote_calendar? ( ~dev-python/ical-9.0.3[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.13.0[${PYTHON_USEDEP}] )
	...
	roborock? ( ~dev-python/python-roborock-2.16.1[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.2[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartthings-3.0.1[${PYTHON_USEDEP}] )
	...
	snoo? ( ~dev-python/python-snoo-0.6.5[${PYTHON_USEDEP}] )
	...
	sql? ( ~dev-python/sqlalchemy-2.0.39[${PYTHON_USEDEP}] ~dev-python/sqlparse-0.5.0[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.58.0[${PYTHON_USEDEP}] )
	...
	tado? ( ~dev-python/python-tado-0.18.9[${PYTHON_USEDEP}] )
	...
	tensorflow? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.2[${PYTHON_USEDEP}] ~dev-python/pycomfoconnect-0.5.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-1.0.16[${PYTHON_USEDEP}] ~dev-python/thermobeacon-ble-0.8.1[${PYTHON_USEDEP}] )
	tesla_fleet? ( ~dev-python/tesla-fleet-api-1.0.16[${PYTHON_USEDEP}] )
	tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.0.2[${PYTHON_USEDEP}] )
	teslemetry? ( ~dev-python/tesla-fleet-api-1.0.16[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.6.12[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tesla-fleet-api-1.0.16[${PYTHON_USEDEP}] ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] )
	...
	wallbox? ( ~dev-python/wallbox-0.8.0[${PYTHON_USEDEP}] )
	...
	whirlpool? ( ~dev-python/whirlpool-sixth-sense-0.19.1[${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.69[${PYTHON_USEDEP}] )
	...
	yolink? ( ~dev-python/yolink-api-0.4.9[${PYTHON_USEDEP}] )
	...
	zwave_js? ( ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] ~dev-python/zwave-js-server-python-0.62.0[${PYTHON_USEDEP}] )
