...
# Home Assistant Core dependencies from ./homeassistant-2024.9.0b4/homeassistant/package_constraints.txt
RDEPEND="
	...
	~dev-python/home-assistant-frontend-20240903.1[${PYTHON_USEDEP}]
...
"
# Home Assistant Core dependencies from ./core-2024.9.0b4/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	august? ( ~dev-python/yalexs-ble-2.4.3[${PYTHON_USEDEP}] ~dev-python/yalexs-8.6.2[${PYTHON_USEDEP}] )
	...
	lifx? ( ~dev-python/aiolifx-effects-0.3.2[${PYTHON_USEDEP}] ~dev-python/aiolifx-themes-0.5.0[${PYTHON_USEDEP}] ~dev-python/aiolifx-1.0.9[${PYTHON_USEDEP}] )
