...
# Home Assistant Core dependencies from ./core-2024.10.0b0/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
	~dev-python/aiohasupervisor-0.1.0_beta1[${PYTHON_USEDEP}]
	...
	~dev-python/home-assistant-frontend-20240925.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2024.9.23[${PYTHON_USEDEP}]
...
"
# Home Assistant Core dependencies from ./homeassistant-2024.10.0b0/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	abode? ( ~dev-python/jaraco-abode-6.2.0[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2024.9.10.221729[${PYTHON_USEDEP}] ~dev-python/xknx-3.2.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.7.1[${PYTHON_USEDEP}] )
	...
	python_script? ( ~dev-python/RestrictedPython-7.2[${PYTHON_USEDEP}] )
	...
	ring? ( ~dev-python/ring-doorbell-0.9.5[listen,${PYTHON_USEDEP}] )
	...
	squeezebox? ( ~dev-python/pysqueezebox-0.9.2[${PYTHON_USEDEP}] )
	...
	zwave_js? ( ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] ~dev-python/zwave-js-server-python-0.58.0[${PYTHON_USEDEP}] )
"
