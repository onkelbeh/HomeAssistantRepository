...
# Home Assistant Core dependencies from ./core-2025.3.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250305.0[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./homeassistant-2025.3.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	accuweather? ( ~dev-python/accuweather-4.1.0[${PYTHON_USEDEP}] )
	...
	airzone? ( ~dev-python/aioairzone-0.9.9[${PYTHON_USEDEP}] )
	...
	androidtv_remote? ( ~dev-python/androidtvremote2-0.2.0[${PYTHON_USEDEP}] )
	...
	aprilaire? ( ~dev-python/pyaprilaire-0.7.7[${PYTHON_USEDEP}] )
	...
	august? ( ~dev-python/yalexs-ble-2.5.7[${PYTHON_USEDEP}] ~dev-python/yalexs-8.10.0[${PYTHON_USEDEP}] )
	...
	bang_olufsen? ( ~dev-python/mozart-api-4.1.1.116.4[${PYTHON_USEDEP}] )
	bbox? ( ~dev-python/pybbox-0.0.5_alpha0[${PYTHON_USEDEP}] )
	beewi_smartclim? ( ~dev-python/bimmer-connected-0.17.2[china,${PYTHON_USEDEP}] )
	...
	bluesound? ( ~dev-python/pyblu-2.0.0[${PYTHON_USEDEP}] )
	bluetooth? ( ~dev-python/bleak-retry-connector-3.9.0[${PYTHON_USEDEP}] ~dev-python/bleak-0.22.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.4.4[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.23.4[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.33.0[${PYTHON_USEDEP}] ~dev-python/habluetooth-3.24.1[${PYTHON_USEDEP}] )
	bluetooth_tracker? ( ~dev-python/pychromecast-14.0.5[${PYTHON_USEDEP}] ~dev-python/bt-proximity-0.2.1[${PYTHON_USEDEP}] )
	bmw_connected_drive? ( ~dev-python/bimmer-connected-0.17.2[china,${PYTHON_USEDEP}] )
	...
	bring? ( ~dev-python/bring-api-1.0.2[${PYTHON_USEDEP}] )
	...
	comelit? ( ~dev-python/aiocomelit-0.10.1[${PYTHON_USEDEP}] )
	...
	conversation? ( ~dev-python/hassil-2.2.3[${PYTHON_USEDEP}] ~dev-python/home-assistant-intents-2025.3.5[${PYTHON_USEDEP}] )
	...
	cups? ( ~dev-python/pydaikin-2.13.8[${PYTHON_USEDEP}] )
	...
	debugpy? ( ~dev-python/debugpy-1.8.11[${PYTHON_USEDEP}] )
	deconz? ( ~dev-python/pydeconz-118[${PYTHON_USEDEP}] )
	decora? ( ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/deebot-client-12.3.1[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-12.3.1[${PYTHON_USEDEP}] )
	...
	dhcp? ( ~dev-python/aiodhcpwatcher-1.1.1[${PYTHON_USEDEP}] ~dev-python/aiodiscover-2.6.1[${PYTHON_USEDEP}] ~dev-python/cached-ipaddress-0.9.2[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.43.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] )
	dlna_dms? ( ~dev-python/async-upnp-client-0.43.0[${PYTHON_USEDEP}] )
	dnsip? ( ~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}] )
	dominos? ( ~dev-python/pizzapi-0.0.6[${PYTHON_USEDEP}] )
	doods? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/pydoods-1.0.2[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-12.3.1[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	eheimdigital? ( ~dev-python/eheimdigital-1.0.6[${PYTHON_USEDEP}] )
	...
	emulated_kasa? ( ~dev-python/sense-energy-0.13.6[${PYTHON_USEDEP}] )
	...
	enphase_envoy? ( ~dev-python/pyenphase-1.25.1[${PYTHON_USEDEP}] )
	entur_public_transport? ( ~dev-python/enturclient-0.2.4[${PYTHON_USEDEP}] )
	environment_canada? ( ~dev-python/env-canada-0.8.0[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/bleak-esphome-2.8.0[${PYTHON_USEDEP}] ~dev-python/eq3btsmart-1.4.1[${PYTHON_USEDEP}] )
	escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
	esphome? ( ~dev-python/aioesphomeapi-29.2.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.8.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] )
	...
	evohome? ( ~dev-python/evohome-async-1.0.2[${PYTHON_USEDEP}] )
	...
	flux_led? ( ~dev-python/flux-led-1.1.3[${PYTHON_USEDEP}] )
	...
	google_generative_ai_conversation? ( ~dev-python/google-genai-1.1.0[${PYTHON_USEDEP}] )
	google_mail? ( ~dev-python/google-api-python-client-2.71.0[${PYTHON_USEDEP}] )
	google? ( ~dev-python/gcal-sync-7.0.0[${PYTHON_USEDEP}] ~dev-python/ical-8.3.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	...
	google_pubsub? ( ~dev-python/google-cloud-pubsub-2.28.0[${PYTHON_USEDEP}] )
	...
	govee_ble? ( ~dev-python/govee-ble-0.43.0[${PYTHON_USEDEP}] )
	govee_light_local? ( ~dev-python/govee-local-api-2.0.1[${PYTHON_USEDEP}] )
	...
	harmony? ( ~dev-python/aioharmony-0.4.1[${PYTHON_USEDEP}] )
	hassio? ( ~dev-python/aiohasupervisor-0.3.0[${PYTHON_USEDEP}] )
	hdmi_cec? ( ~dev-python/pyCEC-0.5.2[${PYTHON_USEDEP}] )
	heatmiser? ( ~dev-python/heatmiserV3-2.0.3[${PYTHON_USEDEP}] )
	heos? ( ~dev-python/pyheos-1.0.2[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.68[${PYTHON_USEDEP}] )
	homeassistant_hardware? ( ~dev-python/universal-silabs-flasher-0.0.29[${PYTHON_USEDEP}] )
	home_connect? ( ~dev-python/aiohomeconnect-0.16.2[${PYTHON_USEDEP}] )
	homee? ( ~dev-python/pyHomee-1.2.7[${PYTHON_USEDEP}] )
	homekit_controller? ( ~dev-python/aiohomekit-3.2.8[${PYTHON_USEDEP}] )
	homekit? ( ~dev-python/HAP-python-4.9.2[${PYTHON_USEDEP}] ~dev-python/pyqrcode-1.2.1[${PYTHON_USEDEP}] ~dev-python/base36-0.1.1[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.2.6[${PYTHON_USEDEP}] )
	homematicip_cloud? ( ~dev-python/homematicip-1.1.7[${PYTHON_USEDEP}] )
	...
	huawei_lte? ( ~dev-python/huawei-lte-api-1.10.0[${PYTHON_USEDEP}] ~dev-python/stringcase-1.2.0[${PYTHON_USEDEP}] ~dev-python/url-normalize-1.4.3[${PYTHON_USEDEP}] )
	...
	husqvarna_automower? ( ~dev-python/aioautomower-2025.1.1[${PYTHON_USEDEP}] )
	huum? ( ~dev-python/huum-0.7.12[${PYTHON_USEDEP}] )
	hvv_departures? ( ~dev-python/pygti-0.9.4[${PYTHON_USEDEP}] )
	hydrawise? ( ~dev-python/pydrawise-2025.2.0[${PYTHON_USEDEP}] )
	...
	image_upload? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] )
	imap? ( ~dev-python/aioimaplib-2.0.1[${PYTHON_USEDEP}] )
	imgw_pib? ( ~dev-python/imgw-pib-1.0.9[${PYTHON_USEDEP}] )
	improv_ble? ( ~dev-python/py-improv-ble-client-1.0.3[${PYTHON_USEDEP}] )
	incomfort? ( ~dev-python/incomfort-client-0.6.7[${PYTHON_USEDEP}] )
	influxdb? ( ~dev-python/influxdb-client-1.24.0[${PYTHON_USEDEP}] ~dev-python/influxdb-5.3.1[${PYTHON_USEDEP}] )
	inkbird? ( ~dev-python/inkbird-ble-0.7.1[${PYTHON_USEDEP}] )
	...
	iron_os? ( ~dev-python/pynecil-4.0.1[${PYTHON_USEDEP}] )
	...
	keyboard_remote? ( ~dev-python/asyncinotify-4.2.0[${PYTHON_USEDEP}] ~dev-python/evohome-async-1.0.2[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2025.1.30.194235[${PYTHON_USEDEP}] ~dev-python/xknx-3.6.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.1[${PYTHON_USEDEP}] )
	...
	lamarzocco? ( ~dev-python/pylamarzocco-1.4.7[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/lcn-frontend-0.2.3[${PYTHON_USEDEP}] ~dev-python/pypck-0.8.5[${PYTHON_USEDEP}] )
	ld2410_ble? ( ~dev-python/bluetooth-data-tools-1.23.4[${PYTHON_USEDEP}] ~dev-python/ld2410-ble-0.1.1[${PYTHON_USEDEP}] )
	leaone? ( ~dev-python/leaone-ble-0.1.0[${PYTHON_USEDEP}] )
	led_ble? ( ~dev-python/bluetooth-data-tools-1.23.4[${PYTHON_USEDEP}] ~dev-python/led-ble-1.1.6[${PYTHON_USEDEP}] )
	...
	lg_thinq? ( ~dev-python/thinqconnect-1.0.4[${PYTHON_USEDEP}] )
	lidarr? ( ~dev-python/aiopyarr-23.4.0[${PYTHON_USEDEP}] )
	lifx? ( ~dev-python/aiolifx-effects-0.3.2[${PYTHON_USEDEP}] ~dev-python/aiolifx-themes-0.6.4[${PYTHON_USEDEP}] ~dev-python/aiolifx-1.1.2[${PYTHON_USEDEP}] )
	...
	linkplay? ( ~dev-python/python-linkplay-0.1.3[${PYTHON_USEDEP}] )
	...
	livisi? ( ~dev-python/livisi-0.0.24[${PYTHON_USEDEP}] )
	local_calendar? ( ~dev-python/ical-8.3.0[${PYTHON_USEDEP}] )
	local_todo? ( ~dev-python/ical-8.3.0[${PYTHON_USEDEP}] )
	...
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.23.0[${PYTHON_USEDEP}] )
	...
	matrix? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/matrix-nio-0.25.2[${PYTHON_USEDEP}] )
	matter? ( ~dev-python/python-matter-server-7.0.0[${PYTHON_USEDEP}] )
	maxcube? ( ~dev-python/maxcube-api-0.4.3[${PYTHON_USEDEP}] )
	mcp? ( ~dev-python/mcp-1.1.2[${PYTHON_USEDEP}] )
	mcp_server? ( ~dev-python/aiohttp_sse-2.2.0[${PYTHON_USEDEP}] ~dev-python/anyio-4.8.0[${PYTHON_USEDEP}] ~dev-python/mcp-1.1.2[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2025.02.19[default,${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/mill-local-0.3.0[${PYTHON_USEDEP}] ~dev-python/millheater-0.12.3[${PYTHON_USEDEP}] )
	...
	music_assistant? ( ~dev-python/music-assistant-client-1.1.1[${PYTHON_USEDEP}] )
	...
	nam? ( ~dev-python/nettigo-air-monitor-4.0.0[${PYTHON_USEDEP}] )
	...
	nexia? ( ~dev-python/nexia-2.2.1[${PYTHON_USEDEP}] )
	...
	nibe_heatpump? ( ~dev-python/nibe-2.14.0[${PYTHON_USEDEP}] )
	...
	nina? ( ~dev-python/PyNINA-0.3.4[${PYTHON_USEDEP}] )
	...
	nyt_games? ( ~dev-python/nyt_games-0.4.4[${PYTHON_USEDEP}] )
	...
	ohme? ( ~dev-python/ohme-1.3.2[${PYTHON_USEDEP}] )
	...
	oncue? ( ~dev-python/aiooncue-0.3.9[${PYTHON_USEDEP}] )
	ondilo_ico? ( ~dev-python/ondilo-0.5.0[${PYTHON_USEDEP}] )
	onedrive? ( ~dev-python/onedrive-personal-sdk-0.0.13[${PYTHON_USEDEP}] )
	...
	openai_conversation? ( ~dev-python/openai-1.61.0[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.9.0[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.16.0[${PYTHON_USEDEP}] )
	...
	pglab? ( ~dev-python/pypglab-0.0.3[${PYTHON_USEDEP}] )
	philips_js? ( ~dev-python/ha-philipsjs-3.2.2[${PYTHON_USEDEP}] )
	picnic? ( ~dev-python/python-picnic-api2-1.2.2[${PYTHON_USEDEP}] )
	...
	plugwise? ( ~dev-python/plugwise-1.7.2[${PYTHON_USEDEP}] )
	...
	private_ble_device? ( ~dev-python/bluetooth-data-tools-1.23.4[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	recorder? ( ~dev-python/sqlalchemy-2.0.38[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.2.6[${PYTHON_USEDEP}] ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] )
	...
	renault? ( ~dev-python/renault-api-0.2.9[${PYTHON_USEDEP}] )
	renson? ( ~dev-python/renson-endura-delta-1.7.2[${PYTHON_USEDEP}] )
	reolink? ( ~dev-python/reolink-aio-0.12.1[${PYTHON_USEDEP}] )
	...
	roborock? ( ~dev-python/python-roborock-2.11.1[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.2[${PYTHON_USEDEP}] )
	...
	russound_rio? ( ~dev-python/aiorussound-4.4.0[${PYTHON_USEDEP}] )
	...
	samsungtv? ( ~dev-python/async-upnp-client-0.43.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[websocket,${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.7.2[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-2.1.0[${PYTHON_USEDEP}] )
	sanix? ( ~dev-python/sanix-1.0.6[${PYTHON_USEDEP}] )
	satel_integra? ( ~dev-python/satel-integra-0.3.7[${PYTHON_USEDEP}] )
	schlage? ( ~dev-python/pyschlage-2024.11.0[${PYTHON_USEDEP}] )
	...
	sense? ( ~dev-python/sense-energy-0.13.6[${PYTHON_USEDEP}] )
	...
	sensorpush_cloud? ( ~dev-python/sensorpush-api-2.1.1[${PYTHON_USEDEP}] ~dev-python/sensorpush-ha-1.3.2[${PYTHON_USEDEP}] )
	...
	serial? ( ~dev-python/pyserial-asyncio-fast-0.14[${PYTHON_USEDEP}] )
	serial_pm? ( ~dev-python/pmsensor-0.4[${PYTHON_USEDEP}] )
	sesame? ( ~dev-python/pysesame2-1.0.1[${PYTHON_USEDEP}] )
	seven_segments? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-13.1.0[${PYTHON_USEDEP}] )
	shodan? ( ~net-analyzer/shodan-1.28.0[${PYTHON_USEDEP}] )
	sia? ( ~dev-python/pysiaalarm-3.1.1[${PYTHON_USEDEP}] )
	sighthound? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	slack? ( ~dev-python/slack_sdk-3.33.4[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartthings-2.5.0[${PYTHON_USEDEP}] )
	smarttub? ( ~dev-python/python-smarttub-0.0.39[${PYTHON_USEDEP}] )
	smarty? ( ~dev-python/pysmarty2-0.10.2[${PYTHON_USEDEP}] )
	smhi? ( ~dev-python/pysmhi-1.0.0[${PYTHON_USEDEP}] )
	smlight? ( ~dev-python/pysmlight-0.2.3[${PYTHON_USEDEP}] )
	...
	snoo? ( ~dev-python/python-snoo-0.6.0[${PYTHON_USEDEP}] )
	...
	sql? ( ~dev-python/sqlalchemy-2.0.38[${PYTHON_USEDEP}] ~dev-python/sqlparse-0.5.0[${PYTHON_USEDEP}] )
	squeezebox? ( ~dev-python/pysqueezebox-0.12.0[${PYTHON_USEDEP}] )
	srp_energy? ( ~dev-python/srpenergy-1.3.6[${PYTHON_USEDEP}] )
	ssdp? ( ~dev-python/async-upnp-client-0.43.0[${PYTHON_USEDEP}] )
	...
	suez_water? ( ~dev-python/pysuezV2-2.0.3[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.56.1[${PYTHON_USEDEP}] )
	...
	syncthru? ( ~dev-python/PySyncThru-0.8.0[${PYTHON_USEDEP}] ~dev-python/url-normalize-1.4.3[${PYTHON_USEDEP}] )
	synology_dsm? ( ~dev-python/py-synologydsm-api-2.7.0[${PYTHON_USEDEP}] )
	...
	systemmonitor? ( ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] ~dev-python/psutil-6.1.1[${PYTHON_USEDEP}] )
	tado? ( ~dev-python/python-tado-0.18.6[${PYTHON_USEDEP}] )
	...
	tensorflow? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.2[${PYTHON_USEDEP}] ~dev-python/pycomfoconnect-0.5.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-0.9.12[${PYTHON_USEDEP}] ~dev-python/thermobeacon-ble-0.8.0[${PYTHON_USEDEP}] )
	tesla_fleet? ( ~dev-python/tesla-fleet-api-0.9.12[${PYTHON_USEDEP}] )
	tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.0.2[${PYTHON_USEDEP}] )
	teslemetry? ( ~dev-python/tesla-fleet-api-0.9.12[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.6.10[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tesla-fleet-api-0.9.12[${PYTHON_USEDEP}] ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] )
	thermobeacon? ( ~dev-python/thermobeacon-ble-0.8.0[${PYTHON_USEDEP}] )
	thermopro? ( ~dev-python/thermopro-ble-0.11.0[${PYTHON_USEDEP}] )
	...
	touchline? ( ~dev-python/pytouchline_extended-0.4.5[${PYTHON_USEDEP}] )
	...
	tplink_omada? ( ~dev-python/tplink-omada-client-1.4.3[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-7.5.1[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
	upb? ( ~dev-python/upb-lib-0.6.0[${PYTHON_USEDEP}] )
	upc_connect? ( ~dev-python/connect-box-0.3.1[${PYTHON_USEDEP}] )
	upcloud? ( ~dev-python/upcloud-api-2.6.0[${PYTHON_USEDEP}] )
	upnp? ( ~dev-python/async-upnp-client-0.43.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.5[${PYTHON_USEDEP}] )
	...
	velbus? ( ~dev-python/velbus-aio-2025.1.1[${PYTHON_USEDEP}] )
	...
	vicare? ( ~dev-python/PyViCare-2.43.1[${PYTHON_USEDEP}] )
	...
	voip? ( ~dev-python/voip-utils-0.3.1[${PYTHON_USEDEP}] )
	...
	webdav? ( ~dev-python/aiowebdav2-0.3.1[${PYTHON_USEDEP}] )
	webmin? ( ~dev-python/webmin-xmlrpc-0.0.2[${PYTHON_USEDEP}] )
	webostv? ( ~dev-python/aiowebostv-0.7.3[${PYTHON_USEDEP}] )
	weheat? ( ~dev-python/weheat-2025.2.26[${PYTHON_USEDEP}] )
	wemo? ( ~dev-python/pywemo-1.4.0[${PYTHON_USEDEP}] )
	whirlpool? ( ~dev-python/whirlpool-sixth-sense-0.18.12[${PYTHON_USEDEP}] )
	...
	wolflink? ( ~dev-python/wolf-comm-0.0.19[${PYTHON_USEDEP}] )
	workday? ( ~dev-python/holidays-0.68[${PYTHON_USEDEP}] )
	...
	yale? ( ~dev-python/yalexs-ble-2.5.7[${PYTHON_USEDEP}] ~dev-python/yalexs-8.10.0[${PYTHON_USEDEP}] )
	yale_smart_alarm? ( ~dev-python/yalesmartalarmclient-0.4.3[${PYTHON_USEDEP}] )
	yalexs_ble? ( ~dev-python/yalexs-ble-2.5.7[${PYTHON_USEDEP}] )
	...
	yeelight? ( ~dev-python/async-upnp-client-0.43.0[${PYTHON_USEDEP}] ~dev-python/yeelight-0.7.16[${PYTHON_USEDEP}] )
	yeelightsunflower? ( ~dev-python/yeelightsunflower-0.0.10[${PYTHON_USEDEP}] )
	yi? ( ~dev-python/aioftp-0.21.3[${PYTHON_USEDEP}] )
	yolink? ( ~dev-python/yolink-api-0.4.8[${PYTHON_USEDEP}] )
	...
	zwave_js? ( ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] ~dev-python/zwave-js-server-python-0.60.1[${PYTHON_USEDEP}] )
