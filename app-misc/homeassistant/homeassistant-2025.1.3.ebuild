...
# Home Assistant Core dependencies from ./homeassistant-2025.1.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250109.0[${PYTHON_USEDEP}]
	...
	>=dev-python/urllib3-1.26.5[${PYTHON_USEDEP}]  >=dev-python/uv-0.5.8
...
# Home Assistant Core dependencies from ./core-2025.1.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	backup? ( ~dev-python/cronsim-2.6[${PYTHON_USEDEP}] ~dev-python/securetar-2024.11.0[${PYTHON_USEDEP}] )
	...
	bluetooth? ( ~dev-python/bleak-retry-connector-3.6.0[${PYTHON_USEDEP}] ~dev-python/bleak-0.22.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-0.20.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.4.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.20.0[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.24.3[${PYTHON_USEDEP}] ~dev-python/habluetooth-3.7.0[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.87.0[${PYTHON_USEDEP}] )
	...
	compensation? ( ~dev-python/numpy-2.2.0[${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.20.2[${PYTHON_USEDEP}] ~dev-python/deebot-client-11.0.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-11.0.0[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.42.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] )
	dlna_dms? ( ~dev-python/async-upnp-client-0.42.0[${PYTHON_USEDEP}] )
	dnsip? ( ~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}] )
	dominos? ( ~dev-python/pizzapi-0.0.6[${PYTHON_USEDEP}] )
	doods? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] ~dev-python/pydoods-1.0.2[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-11.0.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/bleak-esphome-2.0.0[${PYTHON_USEDEP}] ~dev-python/eq3btsmart-1.4.1[${PYTHON_USEDEP}] )
	escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
	esphome? ( ~dev-python/aioesphomeapi-28.0.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.0.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] )
	...
	flux_led? ( ~dev-python/flux-led-1.1.0[${PYTHON_USEDEP}] )
	...
	generic? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] ~dev-python/av-13.1.0[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.64[${PYTHON_USEDEP}] )
	...
	homematicip_cloud? ( ~dev-python/homematicip-1.1.5[${PYTHON_USEDEP}] )
	homewizard? ( ~dev-python/python-homewizard-energy-7.0.1[${PYTHON_USEDEP}] )
	homeworks? ( ~dev-python/pyhomeworks-1.1.2[${PYTHON_USEDEP}] )
	home_connect? ( ~dev-python/homeconnect-0.8.0[${PYTHON_USEDEP}] )
	honeywell? ( ~dev-python/AIOSomecomfort-0.0.28[${PYTHON_USEDEP}] )
	...
	husqvarna_automower? ( ~dev-python/aioautomower-2025.1.0[${PYTHON_USEDEP}] )
	...
	imgw_pib? ( ~dev-python/imgw-pib-1.0.7[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-2.2.0[${PYTHON_USEDEP}] ~dev-python/pyiqvia-2022.4.0[${PYTHON_USEDEP}] )
	...
	keyboard_remote? ( ~dev-python/asyncinotify-4.0.2[${PYTHON_USEDEP}] ~dev-python/evohome-async-0.4.21[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2025.1.18.164225[${PYTHON_USEDEP}] ~dev-python/xknx-3.4.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.1[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/lcn-frontend-0.2.2[${PYTHON_USEDEP}] ~dev-python/pypck-0.8.1[${PYTHON_USEDEP}] )
	...
	led_ble? ( ~dev-python/bluetooth-data-tools-1.20.0[${PYTHON_USEDEP}] ~dev-python/led-ble-1.1.1[${PYTHON_USEDEP}] )
	...
	lifx? ( ~dev-python/aiolifx-effects-0.3.2[${PYTHON_USEDEP}] ~dev-python/aiolifx-themes-0.6.0[${PYTHON_USEDEP}] ~dev-python/aiolifx-1.1.2[${PYTHON_USEDEP}] )
	...
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.22.0[${PYTHON_USEDEP}] )
	...
	matrix? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] ~dev-python/matrix-nio-0.25.2[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2025.01.15[default,${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/mill-local-0.3.0[${PYTHON_USEDEP}] ~dev-python/millheater-0.12.2[${PYTHON_USEDEP}] )
	...
	modbus? ( ~dev-python/pymodbus-3.7.4[${PYTHON_USEDEP}] )
	...
	niko_home_control? ( ~dev-python/nhc-0.3.4[${PYTHON_USEDEP}] )
	...
	nmap_tracker? ( ~dev-python/aiooui-0.1.9[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] ~dev-python/netmap-0.7.0.2[${PYTHON_USEDEP}] )
	...
	ollama? ( ~dev-python/ollama-0.4.5[${PYTHON_USEDEP}] )
	...
	onvif? ( ~dev-python/WSDiscovery-2.0.0[${PYTHON_USEDEP}] ~dev-python/onvif-zeep-async-3.2.3[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.8.7[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	renault? ( ~dev-python/renault-api-0.2.8[${PYTHON_USEDEP}] )
	renson? ( ~dev-python/renson-endura-delta-1.7.2[${PYTHON_USEDEP}] )
	reolink? ( ~dev-python/reolink-aio-0.11.6[${PYTHON_USEDEP}] )
	...
	russound_rio? ( ~dev-python/aiorussound-4.1.1[${PYTHON_USEDEP}] )
	...
	samsungtv? ( ~dev-python/async-upnp-client-0.42.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[websocket,${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.7.2[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-2.1.0[${PYTHON_USEDEP}] )
	...
	seven_segments? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] )
	sfr_box? ( ~dev-python/sfrbox-api-0.0.11[${PYTHON_USEDEP}] )
	sharkiq? ( ~dev-python/sharkiq-1.0.2[${PYTHON_USEDEP}] )
	shelly? ( ~dev-python/aioshelly-12.2.0[${PYTHON_USEDEP}] )
	shodan? ( ~net-analyzer/shodan-1.28.0[${PYTHON_USEDEP}] )
	sia? ( ~dev-python/pysiaalarm-3.1.1[${PYTHON_USEDEP}] )
	sighthound? ( ~dev-python/pillow-11.0.0[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/async-upnp-client-0.42.0[${PYTHON_USEDEP}] )
	...
	stream? ( ~dev-python/PyTurboJPEG-1.7.5[${PYTHON_USEDEP}] ~dev-python/av-13.1.0[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.0[${PYTHON_USEDEP}] )
	...
	switcher_kis? ( ~dev-python/aioswitcher-5.1.0[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-0.8.5[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.4.2[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tesla-fleet-api-0.8.5[${PYTHON_USEDEP}] ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] )
	...
	tplink? ( ~dev-python/python-kasa-0.9.1[speedups,${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-2.2.0[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-7.4.1[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
	...
	upnp? ( ~dev-python/async-upnp-client-0.42.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] )
	...
	velbus? ( ~dev-python/velbus-aio-2024.12.2[${PYTHON_USEDEP}] )
	...
	vicare? ( ~dev-python/PyViCare-2.39.1[${PYTHON_USEDEP}] )
	...
	voip? ( ~dev-python/voip-utils-0.2.2[${PYTHON_USEDEP}] )
	...
	whirlpool? ( ~dev-python/whirlpool-sixth-sense-0.18.11[${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.64[${PYTHON_USEDEP}] )
	...
	yeelight? ( ~dev-python/async-upnp-client-0.42.0[${PYTHON_USEDEP}] ~dev-python/yeelight-0.7.14[${PYTHON_USEDEP}] )
	...
	zengge? ( ~dev-python/bluetooth-adapters-0.20.2[${PYTHON_USEDEP}] ~dev-python/zengge-0.2[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.0.25[${PYTHON_USEDEP}] ~dev-python/zha-0.0.45[${PYTHON_USEDEP}] )
