...
# Home Assistant Core dependencies from ./core-2024.11.2/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	>=dev-python/urllib3-1.26.5[${PYTHON_USEDEP}]  >=dev-python/uv-0.4.28
...
# Home Assistant Core dependencies from ./homeassistant-2024.11.2/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	august? ( ~dev-python/yalexs-ble-2.5.0[${PYTHON_USEDEP}] ~dev-python/yalexs-8.10.0[${PYTHON_USEDEP}] )
	...
	beewi_smartclim? ( ~dev-python/bimmer-connected-0.16.4[china,${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.20.0[${PYTHON_USEDEP}] ~dev-python/deebot-client-8.4.0[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/Babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.60[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2024.11.04[default,${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.11.1[${PYTHON_USEDEP}] )
	...
	samsungtv? ( ~dev-python/async-upnp-client-0.41.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[websocket,${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.6.0[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-2.1.0[${PYTHON_USEDEP}] )
	...
	tplink? ( ~dev-python/python-kasa-0.7.7[speedups,${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.60[${PYTHON_USEDEP}] )
	...
	zengge? ( ~dev-python/bluetooth-adapters-0.20.0[${PYTHON_USEDEP}] ~dev-python/zengge-0.2[${PYTHON_USEDEP}] )
