...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20201111.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	environment_canada? ( ~dev-python/env-canada-0.2.2[${PYTHON_USEDEP}] )
	...
	tasmota? ( ~dev-python/HATasmota-0.0.30[${PYTHON_USEDEP}] )
