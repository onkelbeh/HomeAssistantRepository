...
RDEPEND="${PYTHON_DEPS} acct-group/${PN} acct-user/${PN}
	...
	asuswrt? ( ~dev-python/aioasuswrt-1.2.2[${PYTHON_USEDEP}] )
	...
	frontend? ( ~app-misc/home-assistant-frontend-20200312.0[${PYTHON_USEDEP}] )
	...
	homekit? ( ~dev-python/aiohomekit-0.2.29[${PYTHON_USEDEP}] )
	...
	zigbee? ( ~dev-python/zigpy-deconz-0.7.0[${PYTHON_USEDEP}]
			...
			~dev-python/zha-quirks-0.0.36[${PYTHON_USEDEP}] )
