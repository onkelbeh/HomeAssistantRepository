...
# Home Assistant Core dependencies from ./homeassistant-2024.9.0b2/homeassistant/package_constraints.txt
RDEPEND="
	...
	~dev-python/home-assistant-intents-2024.8.29[${PYTHON_USEDEP}]
...
"
# Home Assistant Core dependencies from ./core-2024.9.0b2/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	august? ( ~dev-python/yalexs-ble-2.4.3[${PYTHON_USEDEP}] ~dev-python/yalexs-8.5.5[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.0.22[${PYTHON_USEDEP}] ~dev-python/zha-0.0.32[${PYTHON_USEDEP}] )
