...
RDEPEND="${RDEPEND}
	...
	compensation? ( ~dev-python/numpy-1.20.2[${PYTHON_USEDEP}] )
	...
	hue? ( ~dev-python/aiohue-2.3.1[${PYTHON_USEDEP}] )
	...
	sonos? ( ~dev-python/pysonos-0.0.45[${PYTHON_USEDEP}] )
	...
	tasmota? ( ~dev-python/HATasmota-0.2.12[${PYTHON_USEDEP}] )
