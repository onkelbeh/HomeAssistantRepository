...
# Home Assistant Core dependencies from ./homeassistant-2024.10.0/homeassistant/package_constraints.txt
RDEPEND="
	...
	~dev-python/home-assistant-frontend-20241002.2[${PYTHON_USEDEP}]
...
"
# Home Assistant Core dependencies from ./core-2024.10.0/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	bluetooth_tracker? ( ~dev-python/pychromecast-14.0.2[${PYTHON_USEDEP}] ~dev-python/bt-proximity-0.2.1[${PYTHON_USEDEP}] )
	...
	cast? ( ~dev-python/pychromecast-14.0.2[${PYTHON_USEDEP}] )
