...
RDEPEND="${RDEPEND}
	...
	environment_canada? ( ~dev-python/env-canada-0.10.1[${PYTHON_USEDEP}] )
	...
	led_ble? ( ~dev-python/bluetooth-data-tools-1.26.5[${PYTHON_USEDEP}] ~dev-python/led-ble-1.1.7[${PYTHON_USEDEP}] )
	...
	local_calendar? ( ~dev-python/ical-9.1.0[${PYTHON_USEDEP}] )
	local_todo? ( ~dev-python/ical-9.1.0[${PYTHON_USEDEP}] )
	...
	mcp_server? ( ~dev-python/aiohttp-sse-2.2.0[${PYTHON_USEDEP}] ~dev-python/anyio-4.9.0[${PYTHON_USEDEP}] ~dev-python/mcp-1.5.0[${PYTHON_USEDEP}] )
	...
	remote_calendar? ( ~dev-python/ical-9.1.0[${PYTHON_USEDEP}] )
