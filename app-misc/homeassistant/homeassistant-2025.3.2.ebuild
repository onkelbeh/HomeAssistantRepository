...
# Home Assistant Core dependencies from ./core-2025.3.2/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
# Home Assistant Core dependencies from ./homeassistant-2025.3.2/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	smartthings? ( ~dev-python/pysmartthings-2.7.2[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-0.9.12[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.6.12[${PYTHON_USEDEP}] )
	...
	velbus? ( ~dev-python/velbus-aio-2025.3.0[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/zha-0.0.52[${PYTHON_USEDEP}] )
