...
# Home Assistant Core dependencies from ./homeassistant-2025.2.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/hass-nabucasa-0.90.0[${PYTHON_USEDEP}]
	~dev-python/hassil-2.2.3[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-1.13.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20250210.0[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./core-2025.2.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	cloud? ( ~dev-python/hass-nabucasa-0.90.0[${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/deebot-client-12.1.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-12.1.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-12.1.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	fritzbox? ( ~dev-python/pyfritzhome-0.6.14[${PYTHON_USEDEP}] )
	...
	hive? ( ~dev-python/pyhive-integration-1.0.1[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.11.10[${PYTHON_USEDEP}] )
	...
	synology_dsm? ( ~dev-python/py-synologydsm-api-2.6.2[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-0.9.8[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.6.6[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tesla-fleet-api-0.9.8[${PYTHON_USEDEP}] ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] )
	...
	tplink? ( ~dev-python/python-kasa-0.10.1[speedups,${PYTHON_USEDEP}] )
	...
	vesync? ( ~dev-python/pyvesync-2.1.17[${PYTHON_USEDEP}] )
	...
	webostv? ( ~dev-python/aiowebostv-0.6.1[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/zha-0.0.48[${PYTHON_USEDEP}] )
