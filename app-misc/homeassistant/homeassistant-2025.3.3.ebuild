...
# Home Assistant Core dependencies from ./core-2025.3.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
# Home Assistant Core dependencies from ./homeassistant-2025.3.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
