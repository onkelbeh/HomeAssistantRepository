...
IUSE="abode ambiclimate androidtv asuswrt atmo atv aurora avea axis bitcoin blockchain buienradar ciscomobilityexpress cli daikin darksky denonavr discogs enigma enocean envoy esphome everlights fronius +frontend gpiozero growl harmony heos here hkavr holidays homekit homematic homematicip hpilo hs100 hue incomfort influxdb maxcube maxcube_hack miio mikrotik mqtt musiccast +mysql openwrt plex qnap roku rxv samsungtv shodan sma socat somfy sonos speedtest ssl test tradfri ubee unify vera wemo wink withings wled wwlln xknx yeelight youtube z-wave zigbee zoneminder"
...
RDEPEND="${PYTHON_DEPS}
	...
	androidtv? ( ~dev-python/androidtv-0.0.32[${PYTHON_USEDEP}] ~dev-python/adb-shell-0.0.8[${PYTHON_USEDEP}] )
	...
	mqtt? ( ~dev-python/hbmqtt-0.9.5[${PYTHON_USEDEP}] app-misc/mosquitto )
