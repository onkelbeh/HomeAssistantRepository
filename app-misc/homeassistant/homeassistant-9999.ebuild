...
RDEPEND="${PYTHON_DEPS}
	...
	alpha_vantage? ( ~dev-python/alpha-vantage-2.1.1[${PYTHON_USEDEP}] )
	...
	apprise? ( ~dev-python/apprise-0.8.1[${PYTHON_USEDEP}] )
	...
	atenpdu? ( ~dev-python/atenpdu-0.3.0[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.29[${PYTHON_USEDEP}] )
	...
	discord? ( ~dev-python/discord-py-1.2.4[${PYTHON_USEDEP}] )
	...
	elv? ( ~dev-python/pypca-0.0.5[${PYTHON_USEDEP}] )
	...
	entur_public_transport? ( ~dev-python/enturclient-0.2.0[${PYTHON_USEDEP}] )
	...
	geo_rss_events? ( ~dev-python/georss-generic-client-0.2[${PYTHON_USEDEP}] )
	...
	heatmiser? ( ~dev-python/heatmiserV3-0.9.1[${PYTHON_USEDEP}] )
	heos? ( ~dev-python/pyheos-0.6.0[${PYTHON_USEDEP}] )
	here? ( ~dev-python/herepy-0.6.3.1[${PYTHON_USEDEP}] )
	here_travel_time? ( ~dev-python/herepy-0.6.3.1[${PYTHON_USEDEP}] )
	hikvision? ( ~dev-python/pyHik-0.2.4[${PYTHON_USEDEP}] )
	...
	huawei_lte? ( ~dev-python/getmac-0.8.1[${PYTHON_USEDEP}]
		~dev-python/huawei-lte-api-1.4.3[${PYTHON_USEDEP}]
	...
	iqvia? ( ~dev-python/numpy-1.17.3[${PYTHON_USEDEP}]
	...
	juicenet? ( ~dev-python/python-juicenet-0.1.5[${PYTHON_USEDEP}] )
	kaiterra? ( ~dev-python/kaiterra-async-client-0.0.2[${PYTHON_USEDEP}] )
	keba? ( ~dev-python/keba-kecontact-0.2.0[${PYTHON_USEDEP}] )
	keenetic_ndms2? ( ~dev-python/ndms2-client-0.0.10[${PYTHON_USEDEP}] )
	...
	lupusec? ( ~dev-python/lupupy-0.0.17[${PYTHON_USEDEP}] )
	lutron? ( ~dev-python/pylutron-0.2.5[${PYTHON_USEDEP}] )
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.5.0[${PYTHON_USEDEP}] )
	...
	mitemp_bt? ( ~dev-python/mitemp-bt-0.0.1[${PYTHON_USEDEP}] )
	...
	netgear_lte? ( ~dev-python/eternalegypt-0.0.10[${PYTHON_USEDEP}] )
	...
	nsw_rural_fire_service_feed? ( ~dev-python/geojson-client-0.4[${PYTHON_USEDEP}] )
	...
	ps4? ( ~dev-python/pyps4-2ndscreen-1.0.1[${PYTHON_USEDEP}] )
	...
	recorder? ( ~dev-python/sqlalchemy-1.3.10[${PYTHON_USEDEP}] )
	...
	rfxtrx? ( ~dev-python/pyRFXtrx-0.23[${PYTHON_USEDEP}] )
	...
	roomba? ( ~dev-python/roombapy-1.3.1[${PYTHON_USEDEP}] )
	...
	season? ( ~dev-python/ephem-3.7.6.0[${PYTHON_USEDEP}] )
	...
	simplisafe? ( ~dev-python/simplisafe-python-5.1.0[${PYTHON_USEDEP}] )
	...
	sql? ( ~dev-python/sqlalchemy-1.3.10[${PYTHON_USEDEP}] )
	ssdp? ( ~dev-python/netdisco-2.6.0[${PYTHON_USEDEP}] )
	...
	sucks? ( ~dev-python/sucks-0.9.4[${PYTHON_USEDEP}] )
	...
	systemmonitor? ( ~dev-python/psutil-5.6.5[${PYTHON_USEDEP}] )
	...
	tensorflow? ( ~dev-python/numpy-1.17.3[${PYTHON_USEDEP}]
		~dev-python/protobuf-python-3.6.1[${PYTHON_USEDEP}] )
	tesla? ( ~dev-python/teslajsonpy-0.0.26[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.11.7[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-1.17.3[${PYTHON_USEDEP}] )
	...
	verisure? ( ~dev-python/jsonpath-0.75[${PYTHON_USEDEP}]
		~dev-python/vsure-1.5.2[${PYTHON_USEDEP}] )
	...
	vivotek? ( ~dev-python/libpyvivotek-0.2.2[${PYTHON_USEDEP}] )
	...
	waze_travel_time? ( ~dev-python/WazeRouteCalculator-0.10[${PYTHON_USEDEP}] )
	...
	zeroconf? ( ~dev-python/zeroconf-0.23.0[${PYTHON_USEDEP}] )
