...
RDEPEND="${PYTHON_DEPS}
  ...
  acct-user/${PN}
	...
	adguard? ( ~dev-python/adguardhome-0.4.0[${PYTHON_USEDEP}] )
	...
	alarmdecoder? ( ~dev-python/alarmdecoder-1.13.9[${PYTHON_USEDEP}] )
	...
	ambient_station? ( ~dev-python/aioambient-1.0.2[${PYTHON_USEDEP}] )
	amcrest? ( ~dev-python/amcrest-1.5.3[${PYTHON_USEDEP}] )
	ampio? ( ~dev-python/asmog-0.0.6[${PYTHON_USEDEP}] )
	android_ip_webcam? ( ~dev-python/pydroid-ipcam-0.8[${PYTHON_USEDEP}] )
	androidtv? ( ~dev-python/adb-shell-0.1.1[${PYTHON_USEDEP}] ~dev-python/androidtv-0.0.39[${PYTHON_USEDEP}] ~dev-python/pure-python-adb-0.2.2[${PYTHON_USEDEP}] )
	...
	dyson? ( ~dev-python/libpurecool-0.6.0[${PYTHON_USEDEP}] )
	...
	homekit? ( ~dev-python/HAP-python-2.7.0[${PYTHON_USEDEP}] )
	...
	nederlandse_spoorwegen? ( ~dev-python/nsapi-3.0.0[${PYTHON_USEDEP}] )
	...
	nws? ( ~dev-python/pynws-0.10.1[${PYTHON_USEDEP}] )
	...
	plex? ( ~dev-python/PlexAPI-3.3.0[${PYTHON_USEDEP}] ~dev-python/plexauth-0.0.5[${PYTHON_USEDEP}] ~dev-python/plexwebsocket-0.0.6[${PYTHON_USEDEP}] )
	...
	rflink? ( ~dev-python/rflink-0.0.50[${PYTHON_USEDEP}] )
	...
	vizio? ( ~dev-python/pyvizio-0.1.4[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/bellows-homeassistant-0.13.1[${PYTHON_USEDEP}] ~dev-python/zha-quirks-0.0.32[${PYTHON_USEDEP}] ~dev-python/zigpy-deconz-0.7.0[${PYTHON_USEDEP}] ~dev-python/zigpy-homeassistant-0.13.0[${PYTHON_USEDEP}] ~dev-python/zigpy-xbee-homeassistant-0.9.0[${PYTHON_USEDEP}] ~dev-python/zigpy-zigate-0.5.1[${PYTHON_USEDEP}] )
