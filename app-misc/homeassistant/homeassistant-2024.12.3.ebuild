...
# Home Assistant Core dependencies from ./core-2024.12.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
# Home Assistant Core dependencies from ./homeassistant-2024.12.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	august? ( ~dev-python/yalexs-ble-2.5.2[${PYTHON_USEDEP}] ~dev-python/yalexs-8.10.0[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.62[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2024.12.06[default,${PYTHON_USEDEP}] )
	...
	starlink? ( ~dev-python/starlink-grpc-core-1.2.0[${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.62[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.5.2[${PYTHON_USEDEP}] )
