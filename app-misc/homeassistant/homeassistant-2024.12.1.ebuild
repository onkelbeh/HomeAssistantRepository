...
# Home Assistant Core dependencies from ./homeassistant-2024.12.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
# Home Assistant Core dependencies from ./core-2024.12.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	aosmith? ( ~dev-python/py-aosmith-1.0.11[${PYTHON_USEDEP}] )
	...
	august? ( ~dev-python/yalexs-ble-2.5.1[${PYTHON_USEDEP}] ~dev-python/yalexs-8.10.0[${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.20.2[${PYTHON_USEDEP}] ~dev-python/deebot-client-9.2.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-9.2.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-9.2.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	ezviz? ( ~dev-python/pyezviz-0.2.2.3[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2024.12.03[default,${PYTHON_USEDEP}] )
	...
	plugwise? ( ~dev-python/plugwise-1.6.0[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.11.4[${PYTHON_USEDEP}] )
	...
	suez_water? ( ~dev-python/pysuezV2-1.3.2[${PYTHON_USEDEP}] )
	...
	tado? ( ~dev-python/python-tado-0.17.7[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.5.1[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.0.25[${PYTHON_USEDEP}] ~dev-python/zha-0.0.41[${PYTHON_USEDEP}] )
