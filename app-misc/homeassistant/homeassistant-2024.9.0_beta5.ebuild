...
# Home Assistant Core dependencies from ./homeassistant-2024.9.0b5/homeassistant/package_constraints.txt
RDEPEND="
	...
	~dev-python/home-assistant-frontend-20240904.0[${PYTHON_USEDEP}]
...
"
# Home Assistant Core dependencies from ./core-2024.9.0b5/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	august? ( ~dev-python/yalexs-ble-2.4.3[${PYTHON_USEDEP}] ~dev-python/yalexs-8.6.3[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2024.9.4.64538[${PYTHON_USEDEP}] ~dev-python/xknx-3.1.1[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.7.1[${PYTHON_USEDEP}] )
