...
# Home Assistant Core dependencies from ./core-2024.10.0b5/homeassistant/package_constraints.txt
RDEPEND="
	...
	~dev-python/home-assistant-frontend-20240927.0[${PYTHON_USEDEP}]
...
"
# Home Assistant Core dependencies from ./homeassistant-2024.10.0b5/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	knx? ( ~dev-python/knx-frontend-2024.9.10.221729[${PYTHON_USEDEP}] ~dev-python/xknx-3.2.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.0[${PYTHON_USEDEP}] )
	...
	tplink? ( ~dev-python/python-kasa-0.7.4[speedups,${PYTHON_USEDEP}] )
