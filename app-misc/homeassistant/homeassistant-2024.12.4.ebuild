...
# Home Assistant Core dependencies from ./homeassistant-2024.12.4/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
# Home Assistant Core dependencies from ./core-2024.12.4/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	overkiz? ( ~dev-python/pyoverkiz-1.15.0[${PYTHON_USEDEP}] )
