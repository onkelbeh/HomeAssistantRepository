...
# Home Assistant Core dependencies from ./core-2025.1.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250106.0[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./homeassistant-2025.1.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	aussie_broadband? ( ~dev-python/pyaussiebb-0.1.4[${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.20.2[${PYTHON_USEDEP}] ~dev-python/deebot-client-10.1.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-10.1.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-10.1.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	flick_electric? ( ~dev-python/PyFlick-1.1.2[${PYTHON_USEDEP}] )
	...
	husqvarna_automower? ( ~dev-python/aioautomower-2024.12.0[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2024.12.26.233449[${PYTHON_USEDEP}] ~dev-python/xknx-3.4.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.1[${PYTHON_USEDEP}] )
	...
	lametric? ( ~dev-python/demetriek-1.1.1[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2024.12.23[default,${PYTHON_USEDEP}] )
	...
	niko_home_control? ( ~dev-python/nhc-0.3.2[${PYTHON_USEDEP}] )
	...
	onvif? ( ~dev-python/WSDiscovery-2.0.0[${PYTHON_USEDEP}] ~dev-python/onvif-zeep-async-3.1.13[${PYTHON_USEDEP}] )
	...
	suez_water? ( ~dev-python/pysuezV2-2.0.1[${PYTHON_USEDEP}] )
