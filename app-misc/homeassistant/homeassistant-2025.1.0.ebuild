...
# Home Assistant Core dependencies from ./core-2025.1.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250103.0[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./homeassistant-2025.1.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	enigma2? ( ~dev-python/openwebifpy-4.3.0[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/bleak-esphome-1.1.0[${PYTHON_USEDEP}] ~dev-python/eq3btsmart-1.4.1[${PYTHON_USEDEP}] )
	escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
	esphome? ( ~dev-python/aioesphomeapi-28.0.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-1.1.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.63[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/python-homewizard-energy-7.0.0[${PYTHON_USEDEP}] )
	...
	lametric? ( ~dev-python/demetriek-1.1.0[${PYTHON_USEDEP}] )
	...
	lifx? ( ~dev-python/aiolifx-effects-0.3.2[${PYTHON_USEDEP}] ~dev-python/aiolifx-themes-0.5.5[${PYTHON_USEDEP}] ~dev-python/aiolifx-1.1.2[${PYTHON_USEDEP}] )
	...
	suez_water? ( ~dev-python/pysuezV2-1.3.5[${PYTHON_USEDEP}] )
	...
	tplink? ( ~dev-python/python-kasa-0.9.0[speedups,${PYTHON_USEDEP}] )
	...
	twentemilieu? ( ~dev-python/twentemilieu-2.2.0[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-7.1.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.0.25[${PYTHON_USEDEP}] ~dev-python/zha-0.0.44[${PYTHON_USEDEP}] )
