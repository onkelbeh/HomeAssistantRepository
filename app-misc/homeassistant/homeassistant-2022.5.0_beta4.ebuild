...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20220429.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	frontend? ( ~dev-python/home-assistant-frontend-20220429.0[${PYTHON_USEDEP}] )
	...
	insteon? ( ~dev-python/pyinsteon-1.1.0_beta3[${PYTHON_USEDEP}] ~dev-python/insteon-frontend-home-assistant-0.1.0[${PYTHON_USEDEP}] )
