...
# Home Assistant Core dependencies from ./core-2024.12.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/hass-nabucasa-0.85.0[${PYTHON_USEDEP}]
	~dev-python/hassil-2.0.5[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-1.13.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20241127.4[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./homeassistant-2024.12.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	cloud? ( ~dev-python/hass-nabucasa-0.85.0[${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.20.2[${PYTHON_USEDEP}] ~dev-python/deebot-client-9.1.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-9.1.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-9.1.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-27.0.3[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-1.1.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] )
	...
	samsungtv? ( ~dev-python/async-upnp-client-0.41.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[websocket,${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.7.1[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-2.1.0[${PYTHON_USEDEP}] )
	...
	tplink? ( ~dev-python/python-kasa-0.8.0[speedups,${PYTHON_USEDEP}] )
