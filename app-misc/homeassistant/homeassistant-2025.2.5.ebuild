...
# Home Assistant Core dependencies from ./core-2025.2.5/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}

	~dev-python/aiodhcpwatcher-1.0.3[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
	~dev-python/aiohasupervisor-0.3.0[${PYTHON_USEDEP}]
	~dev-python/aiohttp-asyncmdnsresolver-0.1.0[${PYTHON_USEDEP}]
	...
	~dev-python/bleak-retry-connector-3.8.1[${PYTHON_USEDEP}]
	...
	~dev-python/fnv-hash-fast-1.2.2[${PYTHON_USEDEP}]
	~dev-python/go2rtc-client-0.1.2[${PYTHON_USEDEP}]
	~dev-python/ha-ffmpeg-3.2.2[${PYTHON_USEDEP}]
	~dev-python/habluetooth-3.21.1[${PYTHON_USEDEP}]
	...
	~dev-python/home-assistant-frontend-20250221.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2025.2.5[${PYTHON_USEDEP}]
	...
	~dev-python/securetar-2025.1.4[${PYTHON_USEDEP}]
	...
	~dev-python/ulid-transform-1.2.0[${PYTHON_USEDEP}]
	>=dev-python/urllib3-1.26.5[${PYTHON_USEDEP}]  >=dev-python/uv-0.5.21
	...
	~dev-python/zeroconf-0.144.1[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./homeassistant-2025.2.5/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	analytics_insights? ( ~dev-python/python-homeassistant-analytics-0.8.1[${PYTHON_USEDEP}] )
	...
	august? ( ~dev-python/yalexs-ble-2.5.6[${PYTHON_USEDEP}] ~dev-python/yalexs-8.10.0[${PYTHON_USEDEP}] )
	...
	backup? ( ~dev-python/cronsim-2.6[${PYTHON_USEDEP}] ~dev-python/securetar-2025.1.4[${PYTHON_USEDEP}] )
	...
	bluetooth? ( ~dev-python/bleak-retry-connector-3.8.1[${PYTHON_USEDEP}] ~dev-python/bleak-0.22.3[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.4.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.23.4[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.33.0[${PYTHON_USEDEP}] ~dev-python/habluetooth-3.21.1[${PYTHON_USEDEP}] )
	...
	bring? ( ~dev-python/bring-api-1.0.0[${PYTHON_USEDEP}] )
	...
	bthome? ( ~dev-python/bthome-ble-3.12.3[${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/deebot-client-12.2.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-12.2.0[${PYTHON_USEDEP}] )
	...
	dhcp? ( ~dev-python/aiodhcpwatcher-1.0.3[${PYTHON_USEDEP}] ~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}] ~dev-python/cached-ipaddress-0.8.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-12.2.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/bleak-esphome-2.7.0[${PYTHON_USEDEP}] ~dev-python/eq3btsmart-1.4.1[${PYTHON_USEDEP}] )
	escea? ( ~dev-python/pescea-1.0.12[${PYTHON_USEDEP}] )
	esphome? ( ~dev-python/aioesphomeapi-29.0.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-2.7.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] )
	...
	fritzbox? ( ~dev-python/pyfritzhome-0.6.15[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.66[${PYTHON_USEDEP}] )
	homekit? ( ~dev-python/HAP-python-4.9.2[${PYTHON_USEDEP}] ~dev-python/pyqrcode-1.2.1[${PYTHON_USEDEP}] ~dev-python/base36-0.1.1[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.2.2[${PYTHON_USEDEP}] )
	...
	ipma? ( ~dev-python/pyipma-3.0.8[${PYTHON_USEDEP}] )
	...
	keyboard_remote? ( ~dev-python/asyncinotify-4.2.0[${PYTHON_USEDEP}] ~dev-python/evohome-async-0.4.21[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2025.1.30.194235[${PYTHON_USEDEP}] ~dev-python/xknx-3.5.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.1[${PYTHON_USEDEP}] )
	...
	lamarzocco? ( ~dev-python/pylamarzocco-1.4.6[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2025.01.26[default,${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/google-nest-sdm-7.1.3[${PYTHON_USEDEP}] )
	...
	niko_home_control? ( ~dev-python/nhc-0.3.9[${PYTHON_USEDEP}] )
	...
	openai_conversation? ( ~dev-python/openai-1.59.9[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.8.9[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.15.5[${PYTHON_USEDEP}] )
	...
	plugwise? ( ~dev-python/plugwise-1.6.4[${PYTHON_USEDEP}] )
	...
	prosegur? ( ~dev-python/pyprosegur-0.0.13[${PYTHON_USEDEP}] )
	...
	recorder? ( ~dev-python/sqlalchemy-2.0.37[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.2.2[${PYTHON_USEDEP}] ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.12.0[${PYTHON_USEDEP}] )
	...
	risco? ( ~dev-python/pyrisco-0.6.5[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-12.4.2[${PYTHON_USEDEP}] )
	...
	smhi? ( ~dev-python/smhi-pkg-1.0.19[${PYTHON_USEDEP}] )
	...
	sonos? ( ~dev-python/soco-0.30.8[${PYTHON_USEDEP}] ~dev-python/sonos-websocket-0.1.3[${PYTHON_USEDEP}] )
	...
	sql? ( ~dev-python/sqlalchemy-2.0.37[${PYTHON_USEDEP}] ~dev-python/sqlparse-0.5.0[${PYTHON_USEDEP}] )
	squeezebox? ( ~dev-python/pysqueezebox-0.11.1[${PYTHON_USEDEP}] )
	...
	stookwijzer? ( ~dev-python/stookwijzer-1.5.1[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.55.4[${PYTHON_USEDEP}] )
	...
	synology_dsm? ( ~dev-python/py-synologydsm-api-2.6.3[${PYTHON_USEDEP}] )
	...
	tado? ( ~dev-python/python-tado-0.18.5[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-0.9.10[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.6.6[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tesla-fleet-api-0.9.10[${PYTHON_USEDEP}] ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] )
	thermobeacon? ( ~dev-python/thermobeacon-ble-0.7.0[${PYTHON_USEDEP}] )
	thermopro? ( ~dev-python/thermopro-ble-0.10.1[${PYTHON_USEDEP}] )
	...
	upb? ( ~dev-python/upb-lib-0.5.9[${PYTHON_USEDEP}] )
	...
	vicare? ( ~dev-python/PyViCare-2.41.0[${PYTHON_USEDEP}] )
	...
	webostv? ( ~dev-python/aiowebostv-0.6.2[${PYTHON_USEDEP}] )
	...
	withings? ( ~dev-python/aiowithings-3.1.5[${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.66[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.5.6[${PYTHON_USEDEP}] )
	...
	zwave_js? ( ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] ~dev-python/zwave-js-server-python-0.60.0[${PYTHON_USEDEP}] )
