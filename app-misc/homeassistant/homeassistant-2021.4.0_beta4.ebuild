...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20210402.1[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	cast? ( ~dev-python/pychromecast-9.1.1[${PYTHON_USEDEP}] )
	...
	kodi? ( ~dev-python/pykodi-0.2.3[${PYTHON_USEDEP}] )
	...
	maxcube? ( ~dev-python/maxcube-api-0.4.1[${PYTHON_USEDEP}] )
	...
	philips_js? ( ~dev-python/ha-philipsjs-2.3.2[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/bellows-0.23.1[${PYTHON_USEDEP}] ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] ~dev-python/pyserial-asyncio-0.5[${PYTHON_USEDEP}] ~dev-python/zha-quirks-0.0.55[${PYTHON_USEDEP}] ~dev-python/zigpy-cc-0.5.2[${PYTHON_USEDEP}] ~dev-python/zigpy-deconz-0.12.0[${PYTHON_USEDEP}] ~dev-python/zigpy-0.33.0[${PYTHON_USEDEP}] ~dev-python/zigpy-xbee-0.13.0[${PYTHON_USEDEP}] ~dev-python/zigpy-zigate-0.7.3[${PYTHON_USEDEP}] ~dev-python/zigpy-znp-0.4.0[${PYTHON_USEDEP}] )
	...
	zwave_js? ( ~dev-python/zwave-js-server-python-0.23.0[${PYTHON_USEDEP}] )"
