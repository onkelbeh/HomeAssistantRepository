...
# Home Assistant Core dependencies from ./homeassistant-2025.1.4/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
# Home Assistant Core dependencies from ./core-2025.1.4/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
