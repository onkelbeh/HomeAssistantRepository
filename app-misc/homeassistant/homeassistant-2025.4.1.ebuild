...
RDEPEND="${RDEPEND}
	...
	enphase_envoy? ( ~dev-python/pyenphase-1.25.5[${PYTHON_USEDEP}] )
	...
	frontend? ( ~dev-python/home-assistant-frontend-20250404.0[${PYTHON_USEDEP}] )
	...
	keyboard_remote? ( ~dev-python/asyncinotify-4.2.0[${PYTHON_USEDEP}] ~dev-python/evohome-async-1.0.5[${PYTHON_USEDEP}] )
	...
	tado? ( ~dev-python/python-tado-0.18.11[${PYTHON_USEDEP}] )
	...
	tensorflow? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.2[${PYTHON_USEDEP}] ~dev-python/pycomfoconnect-0.5.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-1.0.17[${PYTHON_USEDEP}] ~dev-python/thermobeacon-ble-0.8.1[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-1.0.17[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.6.12[${PYTHON_USEDEP}] )
