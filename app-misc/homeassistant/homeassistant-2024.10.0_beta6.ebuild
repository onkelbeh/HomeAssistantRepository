...
# Home Assistant Core dependencies from ./core-2024.10.0b6/homeassistant/package_constraints.txt
RDEPEND="
...
"
# Home Assistant Core dependencies from ./homeassistant-2024.10.0b6/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
