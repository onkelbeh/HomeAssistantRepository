...
# Home Assistant Core dependencies from ./core-2024.9.0b0/homeassistant/package_constraints.txt
RDEPEND="
	...
	~dev-python/habluetooth-3.3.2[${PYTHON_USEDEP}]
	...
	~dev-python/home-assistant-frontend-20240828.0[${PYTHON_USEDEP}]
...
"
# Home Assistant Core dependencies from ./homeassistant-2024.9.0b0/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	apple_tv? ( ~dev-python/pyatv-0.15.0[${PYTHON_USEDEP}] )
	...
	august? ( ~dev-python/yalexs-ble-2.4.3[${PYTHON_USEDEP}] ~dev-python/yalexs-8.5.4[${PYTHON_USEDEP}] )
	...
	beewi_smartclim? ( ~dev-python/bimmer-connected-0.16.2[china,${PYTHON_USEDEP}] )
	...
	daikin? ( ~dev-python/pydaikin-2.13.4[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-25.2.1[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-1.0.0[${PYTHON_USEDEP}] ~dev-python/esphome-dashboard-api-1.2.3[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/Babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.55[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2024.8.9.225351[${PYTHON_USEDEP}] ~dev-python/xknx-3.1.1[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.7.1[${PYTHON_USEDEP}] )
	...
	lifx? ( ~dev-python/aiolifx-effects-0.3.2[${PYTHON_USEDEP}] ~dev-python/aiolifx-themes-0.5.0[${PYTHON_USEDEP}] ~dev-python/aiolifx-1.0.8[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-11.3.0[${PYTHON_USEDEP}] )
	...
	tplink? ( ~dev-python/python-kasa-0.7.1[speedups,${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.55[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.0.22[${PYTHON_USEDEP}] ~dev-python/zha-0.0.31[${PYTHON_USEDEP}] )
