...
# Home Assistant Core dependencies from ./core-2024.9.0b3/homeassistant/package_constraints.txt
RDEPEND="
	...
	~dev-python/home-assistant-frontend-20240902.0[${PYTHON_USEDEP}]
...
"
# Home Assistant Core dependencies from ./homeassistant-2024.9.0b3/homeassistant/package_constraints.txt
RDEPEND="
	~dev-python/aiodhcpwatcher-1.0.2[${PYTHON_USEDEP}]
	~dev-python/aiodiscover-2.1.0[${PYTHON_USEDEP}]
	~dev-python/aiodns-3.2.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	tplink? ( ~dev-python/python-kasa-0.7.2[speedups,${PYTHON_USEDEP}] )
