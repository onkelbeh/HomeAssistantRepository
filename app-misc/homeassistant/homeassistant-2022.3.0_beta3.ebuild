...
RDEPEND="${RDEPEND}
	...
	~dev-python/hass-nabucasa-0.53.1[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20220224.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	frontend? ( ~dev-python/home-assistant-frontend-20220224.0[${PYTHON_USEDEP}] )
