...
RDEPEND="${RDEPEND}
	...
	~dev-python/bleak-retry-connector-4.0.2[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-1.0.1[${PYTHON_USEDEP}] ~dev-python/bleak-retry-connector-4.0.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-adapters-2.0.0[${PYTHON_USEDEP}] ~dev-python/bluetooth-auto-recovery-1.5.2[${PYTHON_USEDEP}] ~dev-python/bluetooth-data-tools-1.28.2[${PYTHON_USEDEP}] ~dev-python/dbus-fast-2.44.3[${PYTHON_USEDEP}] ~dev-python/habluetooth-4.0.2[${PYTHON_USEDEP}] )
	...
	compensation? ( ~dev-python/numpy-2.3.2[${PYTHON_USEDEP}] )
	...
	influxdb? ( ~dev-python/influxdb-5.3.1[${PYTHON_USEDEP}] ~dev-python/influxdb-client-1.48.0[${PYTHON_USEDEP}] )
	isal? ( ~dev-python/isal-1.7.1[${PYTHON_USEDEP}] )
	knx? ( ~dev-python/xknx-3.8.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] ~dev-python/knx-frontend-2025.8.9.63154[${PYTHON_USEDEP}] )
	...
	recorder? ( ~dev-python/sqlalchemy-2.0.41[${PYTHON_USEDEP}] ~dev-python/fnv-hash-fast-1.5.0[${PYTHON_USEDEP}] ~dev-python/psutil-home-assistant-0.0.1[${PYTHON_USEDEP}] )
	...
	scrape? ( ~dev-python/beautifulsoup4-4.13.3[${PYTHON_USEDEP}] ~dev-python/lxml-6.0.0[${PYTHON_USEDEP}] )
	...
	sonos? ( ~dev-python/soco-0.30.11[${PYTHON_USEDEP}] ~dev-python/sonos-websocket-0.1.3[${PYTHON_USEDEP}] )
	speedtestdotnet? ( ~net-analyzer/speedtest-cli-2.1.3[${PYTHON_USEDEP}] )
	spotify? ( ~dev-python/spotifyaio-0.8.11[${PYTHON_USEDEP}] )
	sql? ( ~dev-python/sqlalchemy-2.0.41[${PYTHON_USEDEP}] ~dev-python/sqlparse-0.5.0[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/universal-silabs-flasher-0.0.31[${PYTHON_USEDEP}] ~dev-python/zha-0.0.68[${PYTHON_USEDEP}] )
