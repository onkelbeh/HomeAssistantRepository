...
RDEPEND="${RDEPEND}
	...
	~dev-python/go2rtc-client-0.0.1_beta3[${PYTHON_USEDEP}]
	None
	None
	None
	...
	~dev-python/home-assistant-frontend-20241031.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-intents-2024.10.30[${PYTHON_USEDEP}]
