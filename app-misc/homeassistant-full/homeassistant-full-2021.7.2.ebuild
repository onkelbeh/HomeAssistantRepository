...
RDEPEND="${RDEPEND}
	...
	ambee? ( ~dev-python/ambee-0.3.0[${PYTHON_USEDEP}] )
	...
	aprs? ( ~dev-python/aprslib-0.6.46[${PYTHON_USEDEP}] ~dev-python/geopy-2.1.0[${PYTHON_USEDEP}] )
	...
	debugpy? ( ~dev-python/debugpy-1.3.0[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.19.0[${PYTHON_USEDEP}] )
	...
	eight_sleep? ( ~dev-python/pyEight-0.1.9[${PYTHON_USEDEP}] )
	elgato? ( ~dev-python/elgato-2.1.1[${PYTHON_USEDEP}] )
	...
	ezviz? ( ~dev-python/pyEzviz-0.1.8.9[${PYTHON_USEDEP}] )
	...
	fireservicerota? ( ~dev-python/pyfireservicerota-0.0.42[${PYTHON_USEDEP}] )
	...
	folder_watcher? ( ~dev-python/watchdog-2.1.3[${PYTHON_USEDEP}] )
	foobot? ( ~dev-python/foobot_async-1.0.0[${PYTHON_USEDEP}] )
	forecast_solar? ( ~dev-python/forecast-solar-1.3.1[${PYTHON_USEDEP}] )
	...
	goalzero? ( ~dev-python/goalzero-0.1.7[${PYTHON_USEDEP}] )
	...
	gree? ( ~dev-python/greeclimate-0.11.7[${PYTHON_USEDEP}] )
	...
	huawei_lte? ( ~dev-python/getmac-0.8.2[${PYTHON_USEDEP}] ~dev-python/huawei-lte-api-1.4.18[${PYTHON_USEDEP}] ~dev-python/stringcase-1.2.0[${PYTHON_USEDEP}] ~dev-python/url-normalize-1.4.1[${PYTHON_USEDEP}] )
	...
	image? ( ~dev-python/pillow-8.2.0[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-1.20.3[${PYTHON_USEDEP}] ~dev-python/pyiqvia-1.0.0[${PYTHON_USEDEP}] )
	...
	isy994? ( ~dev-python/pyisy-3.0.0[${PYTHON_USEDEP}] )
	itach? ( ~dev-python/pyitachip2ir-0.0.7[${PYTHON_USEDEP}] )
	izone? ( ~dev-python/python-izone-1.1.6[${PYTHON_USEDEP}] )
	...
	lg_netcast? ( ~dev-python/pylgnetcast-0.3.3[${PYTHON_USEDEP}] )
	...
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.10.0[${PYTHON_USEDEP}] ~dev-python/aiolip-1.1.4[${PYTHON_USEDEP}] )
	lw12wifi? ( ~dev-python/lw12-0.9.2[${PYTHON_USEDEP}] )
	lyft? ( ~dev-python/lyft_rides-0.2[${PYTHON_USEDEP}] )
	lyric? ( ~dev-python/aiolyric-1.0.7[${PYTHON_USEDEP}] )
	...
	mazda? ( ~dev-python/pymazda-0.2.0[${PYTHON_USEDEP}] )
	...
	melcloud? ( ~dev-python/pymelcloud-2.5.3[${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/millheater-0.5.0[${PYTHON_USEDEP}] )
	...
	modbus? ( ~dev-python/pymodbus-2.5.2[${PYTHON_USEDEP}] )
	...
	neato? ( ~dev-python/pybotvac-0.0.21[${PYTHON_USEDEP}] )
	...
	nexia? ( ~dev-python/nexia-0.9.9[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-8.2.0[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	rfxtrx? ( ~dev-python/pyRFXtrx-0.27.0[${PYTHON_USEDEP}] )
	...
	rituals_perfume_genie? ( ~dev-python/pyrituals-0.0.4[${PYTHON_USEDEP}] )
	rmvtransport? ( ~dev-python/PyRMVtransport-0.3.2[${PYTHON_USEDEP}] )
	...
	sendgrid? ( ~dev-python/sendgrid-6.7.0[${PYTHON_USEDEP}] )
	...
	sia? ( ~dev-python/pysiaalarm-3.0.0[${PYTHON_USEDEP}] )
	...
	smarttub? ( ~dev-python/python-smarttub-0.0.25[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/defusedxml-0.7.1[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.19.0[${PYTHON_USEDEP}] )
	...
	switcher_kis? ( ~dev-python/aioswitcher-1.2.3[${PYTHON_USEDEP}] )
	...
	system_bridge? ( ~dev-python/systembridge-1.1.5[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.18.0[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-1.20.3[${PYTHON_USEDEP}] )
	...
	twitter? ( ~dev-python/TwitterAPI-2.7.3[${PYTHON_USEDEP}] )
	...
	yale_smart_alarm? ( ~dev-python/yalesmartalarmclient-0.3.3[${PYTHON_USEDEP}] )
