...
# Home Assistant Core dependencies from ./core-2025.2.4/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250214.0[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./homeassistant-2025.2.4/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
