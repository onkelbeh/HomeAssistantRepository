...
RDEPEND="${RDEPEND}
	...
	google? ( ~dev-python/gcal-sync-6.0.3[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-6.1.1[${PYTHON_USEDEP}] )
	...
	vodafone_station? ( ~dev-python/aiovodafone-0.5.4[${PYTHON_USEDEP}] )
	...
	yolink? ( ~dev-python/yolink-api-0.3.6[${PYTHON_USEDEP}] )
