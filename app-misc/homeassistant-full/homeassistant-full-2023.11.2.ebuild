...
RDEPEND="${RDEPEND}
	...
	adax? ( ~dev-python/adax-0.3.0[${PYTHON_USEDEP}] ~dev-python/Adax-local-0.1.5[${PYTHON_USEDEP}] )
	...
	aemet? ( ~dev-python/AEMET-OpenData-0.4.5[${PYTHON_USEDEP}] )
	...
	airzone_cloud? ( ~dev-python/aioairzone-cloud-0.3.5[${PYTHON_USEDEP}] )
	...
	amazon_polly? ( ~dev-python/boto3-1.28.17[${PYTHON_USEDEP}] )
	...
	anova? ( ~dev-python/anova-wifi-0.10.0[${PYTHON_USEDEP}] )
	...
	aws? ( ~dev-python/aiobotocore-2.6.0[${PYTHON_USEDEP}] )
	...
	bosch_shc? ( ~dev-python/boschshcpy-0.2.57[${PYTHON_USEDEP}] )
	...
	bthome? ( ~dev-python/bthome-ble-3.2.0[${PYTHON_USEDEP}] )
	...
	cisco_webex_teams? ( $(python_gen_cond_dep '~dev-python/webexteamssdk-1.1.1[${PYTHON_USEDEP}]' python3_11) )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.74.0[${PYTHON_USEDEP}] )
	...
	comelit? ( ~dev-python/aiocomelit-0.3.0[${PYTHON_USEDEP}] )
	...
	debugpy? ( ~dev-python/debugpy-1.8.0[${PYTHON_USEDEP}] )
	...
	discovergy? ( ~dev-python/pydiscovergy-2.0.5[${PYTHON_USEDEP}] )
	...
	doods? ( ~dev-python/pydoods-1.0.2[${PYTHON_USEDEP}] ~dev-python/pillow-10.1.0[${PYTHON_USEDEP}] )
	...
	easyenergy? ( ~dev-python/easyenergy-0.3.0[${PYTHON_USEDEP}] )
	...
	ecoforest? ( ~dev-python/pyecoforest-0.3.0[${PYTHON_USEDEP}] )
	...
	electrasmart? ( ~dev-python/pyElectra-1.2.0[${PYTHON_USEDEP}] )
	electric_kiwi? ( ~dev-python/electrickiwi-api-0.8.5[${PYTHON_USEDEP}] )
	elgato? ( ~dev-python/elgato-5.0.0[${PYTHON_USEDEP}] )
	eliqonline? ( ~dev-python/eliqonline-1.2.2[${PYTHON_USEDEP}] )
	elkm1? ( ~dev-python/elkm1-lib-2.2.6[${PYTHON_USEDEP}] )
	elmax? ( ~dev-python/elmax-api-0.0.4[${PYTHON_USEDEP}] )
	...
	energyzero? ( ~dev-python/energyzero-0.5.0[${PYTHON_USEDEP}] )
	...
	flipr? ( ~dev-python/flipr-api-1.5.0[${PYTHON_USEDEP}] )
	...
	garages_amsterdam? ( ~dev-python/odp-amsterdam-5.3.1[${PYTHON_USEDEP}] )
	gardena_bluetooth? ( ~dev-python/gardena-bluetooth-1.4.0[${PYTHON_USEDEP}] )
	...
	generic? ( ~dev-python/ha-av-10.1.1[${PYTHON_USEDEP}] ~dev-python/pillow-10.1.0[${PYTHON_USEDEP}] )
	...
	glances? ( ~dev-python/glances-api-0.4.3[${PYTHON_USEDEP}] )
	...
	goodwe? ( ~dev-python/goodwe-0.2.31[${PYTHON_USEDEP}] )
	google? ( ~dev-python/gcal-sync-5.0.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	google_assistant_sdk? ( ~dev-python/gassist-text-0.0.10[${PYTHON_USEDEP}] )
	google_cloud? ( ~dev-python/google-cloud-texttospeech-2.12.3[${PYTHON_USEDEP}] )
	google_generative_ai_conversation? ( ~dev-python/google-generativeai-0.1.0[${PYTHON_USEDEP}] )
	...
	govee_ble? ( ~dev-python/govee-ble-0.24.0[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/python-homewizard-energy-2.1.2[${PYTHON_USEDEP}] )
	...
	honeywell? ( ~dev-python/AIOSomecomfort-0.0.17[${PYTHON_USEDEP}] )
	...
	idasen_desk? ( ~dev-python/idasen-ha-2.3[${PYTHON_USEDEP}] )
	...
	iotawatt? ( ~dev-python/ha-iotawattpy-0.1.1[${PYTHON_USEDEP}] )
	...
	jvc_projector? ( ~dev-python/pyjvcprojector-1.0.6[${PYTHON_USEDEP}] )
	...
	ld2410_ble? ( ~dev-python/bluetooth-data-tools-1.14.0[${PYTHON_USEDEP}] ~dev-python/ld2410-ble-0.1.1[${PYTHON_USEDEP}] )
	led_ble? ( ~dev-python/bluetooth-data-tools-1.14.0[${PYTHON_USEDEP}] ~dev-python/led-ble-1.0.1[${PYTHON_USEDEP}] )
	...
	life360? ( ~dev-python/life360-6.0.0[${PYTHON_USEDEP}] )
	...
	loqed? ( ~dev-python/loqedAPI-2.1.8[${PYTHON_USEDEP}] )
	...
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.18.3[${PYTHON_USEDEP}] )
	...
	matrix? ( ~dev-python/matrix-nio-0.22.1[${PYTHON_USEDEP}] ~dev-python/pillow-10.1.0[${PYTHON_USEDEP}] )
	...
	metoffice? ( $(python_gen_cond_dep '~dev-python/datapoint-0.9.8[${PYTHON_USEDEP}]' python3_11) )
	...
	mill? ( ~dev-python/millheater-0.11.6[${PYTHON_USEDEP}] ~dev-python/mill-local-0.3.0[${PYTHON_USEDEP}] )
	minecraft_server? ( ~dev-python/mcstatus-11.0.0[${PYTHON_USEDEP}] )
	...
	motion_blinds? ( ~dev-python/motionblinds-0.6.18[${PYTHON_USEDEP}] )
	...
	nam? ( ~dev-python/nettigo-air-monitor-2.2.0[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/google-nest-sdm-3.0.3[${PYTHON_USEDEP}] )
	...
	norway_air? ( ~dev-python/PyMetno-0.11.0[${PYTHON_USEDEP}] )
	notify_events? ( ~dev-python/notify-events-1.0.4[${PYTHON_USEDEP}] )
	notion? ( ~dev-python/aionotion-2023.5.5[${PYTHON_USEDEP}] )
	...
	oncue? ( ~dev-python/aiooncue-0.3.5[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.0.39[${PYTHON_USEDEP}] )
	...
	otbr? ( ~dev-python/python-otbr-api-2.5.0[${PYTHON_USEDEP}] )
	otp? ( ~dev-python/pyotp-2.8.0[${PYTHON_USEDEP}] )
	overkiz? ( ~dev-python/pyoverkiz-1.12.1[${PYTHON_USEDEP}] )
	...
	pegel_online? ( ~dev-python/aiopegelonline-0.0.6[${PYTHON_USEDEP}] )
	...
	private_ble_device? ( ~dev-python/bluetooth-data-tools-1.14.0[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-10.1.0[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-10.1.0[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	renault? ( ~dev-python/renault-api-0.2.0[${PYTHON_USEDEP}] )
	renson? ( ~dev-python/renson-endura-delta-1.6.0[${PYTHON_USEDEP}] )
	reolink? ( ~dev-python/reolink-aio-0.7.14[${PYTHON_USEDEP}] )
	...
	rflink? ( ~dev-python/rflink-0.0.65[${PYTHON_USEDEP}] )
	rfxtrx? ( ~dev-python/pyRFXtrx-0.30.1[${PYTHON_USEDEP}] )
	ridwell? ( ~dev-python/aioridwell-2023.7.0[${PYTHON_USEDEP}] )
	...
	route53? ( ~dev-python/boto3-1.28.17[${PYTHON_USEDEP}] )
	...
	schlage? ( ~dev-python/pyschlage-2023.10.0[${PYTHON_USEDEP}] )
	...
	screenlogic? ( ~dev-python/screenlogicpy-0.9.4[${PYTHON_USEDEP}] )
	...
	sensibo? ( ~dev-python/pysensibo-1.0.35[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-1.31.0[${PYTHON_USEDEP}] )
	...
	seven_segments? ( ~dev-python/pillow-10.1.0[${PYTHON_USEDEP}] )
	sfr_box? ( ~dev-python/sfrbox-api-0.0.6[${PYTHON_USEDEP}] )
	...
	sighthound? ( ~dev-python/pillow-10.1.0[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	sleepiq? ( ~dev-python/asyncsleepiq-1.3.7[${PYTHON_USEDEP}] )
	slide? ( ~dev-python/goslide-api-0.5.1[${PYTHON_USEDEP}] )
	slimproto? ( ~dev-python/aioslimproto-2.3.3[${PYTHON_USEDEP}] )
	...
	smarttub? ( ~dev-python/python-smarttub-0.0.35[${PYTHON_USEDEP}] )
	...
	snapcast? ( ~dev-python/snapcast-2.3.3[${PYTHON_USEDEP}] )
	...
	subaru? ( ~dev-python/subarulink-0.7.8[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.40.1[${PYTHON_USEDEP}] )
	switchbot_cloud? ( ~dev-python/switchbot-api-1.2.1[${PYTHON_USEDEP}] )
	switcher_kis? ( ~dev-python/aioswitcher-3.3.0[${PYTHON_USEDEP}] )
	...
	system_bridge? ( ~dev-python/systembridgeconnector-3.8.4[${PYTHON_USEDEP}] )
	tado? ( ~dev-python/python-tado-0.15.0[${PYTHON_USEDEP}] )
	...
	thread? ( ~dev-python/python-otbr-api-2.5.0[${PYTHON_USEDEP}] ~dev-python/pyroute2-0.7.5[${PYTHON_USEDEP}] )
	...
	tplink_omada? ( ~dev-python/tplink-omada-client-1.3.2[${PYTHON_USEDEP}] )
	...
	trafikverket_camera? ( ~dev-python/pytrafikverket-0.3.7[${PYTHON_USEDEP}] )
	trafikverket_ferry? ( ~dev-python/pytrafikverket-0.3.7[${PYTHON_USEDEP}] )
	trafikverket_train? ( ~dev-python/pytrafikverket-0.3.7[${PYTHON_USEDEP}] )
	trafikverket_weatherstation? ( ~dev-python/pytrafikverket-0.3.7[${PYTHON_USEDEP}] )
	...
	twentemilieu? ( ~dev-python/twentemilieu-2.0.0[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.20.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.7[${PYTHON_USEDEP}] )
	...
	vilfo? ( ~dev-python/vilfo-api-client-0.4.1[${PYTHON_USEDEP}] )
	...
	vodafone_station? ( ~dev-python/aiovodafone-0.4.2[${PYTHON_USEDEP}] )
	...
	wallbox? ( ~dev-python/wallbox-0.4.14[${PYTHON_USEDEP}] )
	...
	weatherkit? ( ~dev-python/apple_weatherkit-1.0.4[${PYTHON_USEDEP}] )
	webostv? ( ~dev-python/aiowebostv-0.3.3[${PYTHON_USEDEP}] )
	wemo? ( ~dev-python/pywemo-1.3.0[${PYTHON_USEDEP}] )
	whirlpool? ( ~dev-python/whirlpool-sixth-sense-0.18.4[${PYTHON_USEDEP}] )
	...
	wolflink? ( ~dev-python/wolf-smartset-0.1.11[${PYTHON_USEDEP}] )
	workday? ( ~dev-python/holidays-0.35[${PYTHON_USEDEP}] )
	ws66i? ( ~dev-python/pyws66i-1.1[${PYTHON_USEDEP}] )
	wyoming? ( ~dev-python/wyoming-1.2.0[${PYTHON_USEDEP}] )
	...
	xiaomi_ble? ( ~dev-python/xiaomi-ble-0.21.1[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.3.2[${PYTHON_USEDEP}] )
