...
RDEPEND="${RDEPEND}
	...
	hive? ( ~dev-python/pyhiveapi-0.5.9[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-3.9.2[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.3[${PYTHON_USEDEP}] )
