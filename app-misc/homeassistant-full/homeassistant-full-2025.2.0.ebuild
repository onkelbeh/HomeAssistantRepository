...
# Home Assistant Core dependencies from ./core-2025.2.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/aiohttp-asyncmdnsresolver-0.0.3[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./homeassistant-2025.2.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	govee_ble? ( ~dev-python/govee-ble-0.42.0[${PYTHON_USEDEP}] )
	...
	habitica? ( ~dev-python/habiticalib-0.3.4[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/babel-2.15.0[${PYTHON_USEDEP}] ~dev-python/holidays-0.65[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/google-nest-sdm-7.1.1[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.11.9[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-12.3.2[${PYTHON_USEDEP}] )
	...
	workday? ( ~dev-python/holidays-0.65[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/zha-0.0.47[${PYTHON_USEDEP}] )
