...
RDEPEND="${RDEPEND}
	...
	google? ( ~dev-python/gcal-sync-6.0.3[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-7.0.3[${PYTHON_USEDEP}] )
	...
	husqvarna_automower? ( ~dev-python/aioautomower-2024.3.3[${PYTHON_USEDEP}] )
	...
	rainforest_raven? ( ~dev-python/aioraven-0.5.2[${PYTHON_USEDEP}] )
	...
	risco? ( ~dev-python/pyrisco-0.5.10[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-5.0.2[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.8[${PYTHON_USEDEP}] )
