...
# Home Assistant Core dependencies from ./core-2025.3.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
# Home Assistant Core dependencies from ./homeassistant-2025.3.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	frontend? ( ~dev-python/home-assistant-frontend-20250306.0[${PYTHON_USEDEP}] )
	...
	home_connect? ( ~dev-python/aiohomeconnect-0.16.3[${PYTHON_USEDEP}] )
	...
	nexia? ( ~dev-python/nexia-2.2.2[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartthings-2.7.0[${PYTHON_USEDEP}] )
	...
	snoo? ( ~dev-python/python-snoo-0.6.1[${PYTHON_USEDEP}] )
	...
	tensorflow? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.2[${PYTHON_USEDEP}] ~dev-python/pycomfoconnect-0.5.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-0.9.12[${PYTHON_USEDEP}] ~dev-python/thermobeacon-ble-0.8.1[${PYTHON_USEDEP}] )
	...
	thermobeacon? ( ~dev-python/thermobeacon-ble-0.8.1[${PYTHON_USEDEP}] )
	...
	webdav? ( ~dev-python/aiowebdav2-0.4.1[${PYTHON_USEDEP}] )
