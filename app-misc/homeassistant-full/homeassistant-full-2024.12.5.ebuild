...
# Home Assistant Core dependencies from ./homeassistant-2024.12.5/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	>=dev-python/urllib3-1.26.5[${PYTHON_USEDEP}]  >=dev-python/uv-0.5.4
...
# Home Assistant Core dependencies from ./core-2024.12.5/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	aemet? ( ~dev-python/AEMET-OpenData-0.6.3[${PYTHON_USEDEP}] )
	...
	androidtv? ( ~dev-python/adb-shell-0.4.4[async,${PYTHON_USEDEP}] ~dev-python/androidtv-0.0.75[async,${PYTHON_USEDEP}] ~dev-python/pure-python-adb-0.3.0-r0[async,${PYTHON_USEDEP}] )
	...
	august? ( ~dev-python/yalexs-ble-2.5.5[${PYTHON_USEDEP}] ~dev-python/yalexs-8.10.0[${PYTHON_USEDEP}] )
	...
	avea? ( ~dev-python/axis-63[${PYTHON_USEDEP}] )
	avion? ( ~dev-python/axis-63[${PYTHON_USEDEP}] )
	...
	bang_olufsen? ( ~dev-python/mozart-api-4.1.1.116.3[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.86.0[${PYTHON_USEDEP}] )
	...
	debugpy? ( ~dev-python/debugpy-1.8.8[${PYTHON_USEDEP}] )
	deconz? ( ~dev-python/pydeconz-118[${PYTHON_USEDEP}] )
	decora? ( ~dev-python/bluetooth-adapters-0.20.2[${PYTHON_USEDEP}] ~dev-python/deebot-client-9.4.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-9.4.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-9.4.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	elmax? ( ~dev-python/elmax-api-0.0.6.3[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-2.1.3[${PYTHON_USEDEP}] ~dev-python/pyiqvia-2022.4.0[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2024.11.16.205004[${PYTHON_USEDEP}] ~dev-python/xknx-3.3.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.1[${PYTHON_USEDEP}] )
	...
	lamarzocco? ( ~dev-python/pylamarzocco-1.2.12[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/lcn-frontend-0.2.2[${PYTHON_USEDEP}] ~dev-python/pypck-0.7.24[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~net-misc/yt-dlp-2024.12.13[default,${PYTHON_USEDEP}] )
	...
	nibe_heatpump? ( ~dev-python/nibe-2.13.0[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.15.3[${PYTHON_USEDEP}] )
	...
	pegel_online? ( ~dev-python/aiopegelonline-0.1.0[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.11.5[${PYTHON_USEDEP}] )
	...
	russound_rio? ( ~dev-python/aiorussound-4.1.0[${PYTHON_USEDEP}] )
	...
	samsungtv? ( ~dev-python/async-upnp-client-0.41.0[${PYTHON_USEDEP}] ~dev-python/getmac-0.9.4[${PYTHON_USEDEP}] ~dev-python/samsungctl-0.7.1[websocket,${PYTHON_USEDEP}] ~dev-python/samsungtvws-2.7.2[async,encrypted,${PYTHON_USEDEP}] ~dev-python/wakeonlan-2.1.0[${PYTHON_USEDEP}] )
	...
	stream? ( ~dev-python/PyTurboJPEG-1.7.5[${PYTHON_USEDEP}] ~dev-python/av-13.1.0[${PYTHON_USEDEP}] ~dev-python/numpy-2.1.3[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.54.0[${PYTHON_USEDEP}] )
	switchbot_cloud? ( ~dev-python/switchbot-api-2.2.1[${PYTHON_USEDEP}] )
	switcher_kis? ( ~dev-python/aioswitcher-5.0.0[${PYTHON_USEDEP}] )
	...
	tplink? ( ~dev-python/python-kasa-0.8.1[speedups,${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-2.1.3[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-6.6.5[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.5.5[${PYTHON_USEDEP}] )
