...
RDEPEND="${RDEPEND}
	...
	elkm1? ( ~dev-python/elkm1-lib-1.2.2[${PYTHON_USEDEP}] )
	...
	generic? ( =dev-python/ha-av-9.1.1_p3 ~dev-python/pillow-9.0.1[${PYTHON_USEDEP}] )
	...
	stream? ( ~dev-python/PyTurboJPEG-1.6.6[${PYTHON_USEDEP}] =dev-python/ha-av-9.1.1_p3 )
