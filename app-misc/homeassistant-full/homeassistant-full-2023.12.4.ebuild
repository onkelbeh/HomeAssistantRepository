...
RDEPEND="${RDEPEND}
	...
	airzone? ( ~dev-python/aioairzone-0.7.2[${PYTHON_USEDEP}] )
	...
	life360? ( ~dev-python/life360-6.0.1[${PYTHON_USEDEP}] )
	...
	motion_blinds? ( ~dev-python/motionblinds-0.6.19[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.8.4[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.22.3[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.7[${PYTHON_USEDEP}] )
