...
RDEPEND="${RDEPEND}
	...
	bthome? ( ~dev-python/bthome-ble-2.5.1[${PYTHON_USEDEP}] )
	...
	devolo_home_network? ( ~dev-python/devolo-plc-api-1.1.0[${PYTHON_USEDEP}] )
	...
	honeywell? ( ~dev-python/AIOSomecomfort-0.0.6[${PYTHON_USEDEP}] )
	...
	lupusec? ( ~dev-python/lupupy-0.2.7[${PYTHON_USEDEP}] )
	...
	mopeka? ( ~dev-python/mopeka-iot-ble-0.4.0[${PYTHON_USEDEP}] )
	...
	otbr? ( ~dev-python/python-otbr-api-1.0.2[${PYTHON_USEDEP}] )
	...
	screenlogic? ( ~dev-python/screenlogicpy-0.6.4[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.6.2[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.7[${PYTHON_USEDEP}] )
	...
	zeversolar? ( ~dev-python/zeversolar-0.3.0[${PYTHON_USEDEP}] )
