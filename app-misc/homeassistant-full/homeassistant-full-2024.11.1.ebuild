...
RDEPEND="${RDEPEND}
	...
	cambridge_audio? ( ~dev-python/aiostreammagic-2.8.4[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/eq3btsmart-1.2.0[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-1.1.0[${PYTHON_USEDEP}] )
	...
	go2rtc? ( ~dev-python/go2rtc-client-0.1.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.2.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-8.2.0[${PYTHON_USEDEP}] )
	google_assistant_sdk? ( ~dev-python/gassist-text-0.0.11[${PYTHON_USEDEP}] )
	google_cloud? ( ~dev-python/google-cloud-texttospeech-2.17.2[${PYTHON_USEDEP}] ~dev-python/google-cloud-speech-2.27.0[${PYTHON_USEDEP}] )
	...
	iron_os? ( ~dev-python/pynecil-0.2.0[${PYTHON_USEDEP}] ~dev-python/aiogithubapi-24.6.0[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/pypck-0.7.24[${PYTHON_USEDEP}] ~dev-python/lcn-frontend-0.2.0[${PYTHON_USEDEP}] )
	...
	lg_thinq? ( ~dev-python/thinqconnect-0.9.9[${PYTHON_USEDEP}] )
	...
	music_assistant? ( ~dev-python/music-assistant-client-1.0.3[${PYTHON_USEDEP}] )
	...
	palazzetti? ( ~dev-python/pypalazzetti-0.1.6[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.10.2[${PYTHON_USEDEP}] )
	...
	tessie? ( ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-0.8.4[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-6.3.2[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.2.0[${PYTHON_USEDEP}] )
