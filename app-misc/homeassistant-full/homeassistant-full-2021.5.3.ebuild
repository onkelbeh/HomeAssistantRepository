...
RDEPEND="${RDEPEND}
	...
	advantage_air? ( ~dev-python/advantage-air-0.2.1[${PYTHON_USEDEP}] )
	aemet? ( ~dev-python/AEMET-OpenData-0.1.8[${PYTHON_USEDEP}] )
	...
	amazon_polly? ( ~dev-python/boto3-1.16.52[${PYTHON_USEDEP}] )
	...
	aws? ( ~dev-python/aiobotocore-1.2.2[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.43.0[${PYTHON_USEDEP}] )
	...
	debugpy? ( ~dev-python/debugpy-1.2.1[${PYTHON_USEDEP}] )
	...
	dhcp? ( ~net-analyzer/scapy-2.4.5 ~dev-python/aiodiscover-1.4.0[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.16.2[${PYTHON_USEDEP}] )
	dnsip? ( ~dev-python/aiodns-2.0.0[${PYTHON_USEDEP}] )
	dominos? ( ~dev-python/pizzapi-0.0.3[${PYTHON_USEDEP}] )
	doods? ( ~dev-python/pydoods-1.0.2[${PYTHON_USEDEP}] ~dev-python/pillow-8.1.2[${PYTHON_USEDEP}] )
	doorbird? ( ~dev-python/DoorBirdPy-2.1.0[${PYTHON_USEDEP}] )
	dovado? ( ~dev-python/dovado-0.4.1[${PYTHON_USEDEP}] )
	dsmr? ( ~dev-python/dsmr-parser-0.29[${PYTHON_USEDEP}] )
	...
	edl21? ( ~dev-python/pysml-0.0.5[${PYTHON_USEDEP}] )
	...
	elgato? ( ~dev-python/elgato-2.0.1[${PYTHON_USEDEP}] )
	eliqonline? ( ~dev-python/eliqonline-1.2.2[${PYTHON_USEDEP}] )
	elkm1? ( ~dev-python/elkm1-lib-0.8.10[${PYTHON_USEDEP}] )
	...
	emulated_kasa? ( ~dev-python/sense-energy-0.9.0[${PYTHON_USEDEP}] )
	...
	ezviz? ( ~dev-python/pyEzviz-0.1.8.7[${PYTHON_USEDEP}] )
	...
	fireservicerota? ( ~dev-python/pyfireservicerota-0.0.40[${PYTHON_USEDEP}] )
	...
	folder_watcher? ( ~dev-python/watchdog-2.0.3[${PYTHON_USEDEP}] )
	...
	geo_rss_events? ( ~dev-python/georss-generic-client-0.4[${PYTHON_USEDEP}] )
	...
	goalzero? ( ~dev-python/goalzero-0.1.4[${PYTHON_USEDEP}] )
	gogogate2? ( ~dev-python/gogogate2-api-3.0.0[${PYTHON_USEDEP}] )
	google? ( ~dev-python/google-api-python-client-1.6.4[${PYTHON_USEDEP}] ~dev-python/httplib2-0.19.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.0.0[${PYTHON_USEDEP}] )
	...
	gree? ( ~dev-python/greeclimate-0.11.4[${PYTHON_USEDEP}] )
	...
	huawei_lte? ( ~dev-python/getmac-0.8.2[${PYTHON_USEDEP}] ~dev-python/huawei-lte-api-1.4.17[${PYTHON_USEDEP}] ~dev-python/stringcase-1.2.0[${PYTHON_USEDEP}] ~dev-python/url-normalize-1.4.1[${PYTHON_USEDEP}] )
	...
	ialarm? ( ~dev-python/pyialarm-1.5[${PYTHON_USEDEP}] )
	...
	image? ( ~dev-python/pillow-8.1.2[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-1.20.2[${PYTHON_USEDEP}] ~dev-python/pyiqvia-0.3.1[${PYTHON_USEDEP}] )
	...
	isy994? ( ~dev-python/pyisy-2.1.1[${PYTHON_USEDEP}] )
	itach? ( ~dev-python/pyitachip2ir-0.0.7[${PYTHON_USEDEP}] )
	izone? ( ~dev-python/python-izone-1.1.4[${PYTHON_USEDEP}] )
	...
	lastfm? ( ~dev-python/pylast-4.2.0[${PYTHON_USEDEP}] )
	launch_library? ( ~dev-python/pylaunches-1.0.0[${PYTHON_USEDEP}] )
	lcn? ( ~dev-python/pypck-0.7.9[${PYTHON_USEDEP}] )
	...
	lifx? ( ~dev-python/aiolifx-0.6.9[${PYTHON_USEDEP}] ~dev-python/aiolifx-effects-0.2.2[${PYTHON_USEDEP}] )
	lifx_legacy? ( ~dev-python/liffylights-0.9.4[${PYTHON_USEDEP}] )
	lightwave? ( ~dev-python/lightwave-0.19[${PYTHON_USEDEP}] )
	...
	litterrobot? ( ~dev-python/pylitterbot-2021.3.1[${PYTHON_USEDEP}] )
	...
	lutron? ( ~dev-python/pylutron-0.2.7[${PYTHON_USEDEP}] )
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.9.0[${PYTHON_USEDEP}] ~dev-python/aiolip-1.1.4[${PYTHON_USEDEP}] )
	lw12wifi? ( ~dev-python/lw12-0.9.2[${PYTHON_USEDEP}] )
	lyft? ( ~dev-python/lyft_rides-0.2[${PYTHON_USEDEP}] )
	lyric? ( ~dev-python/aiolyric-1.0.6[${PYTHON_USEDEP}] )
	...
	mazda? ( ~dev-python/pymazda-0.0.9[${PYTHON_USEDEP}] )
	...
	met? ( ~dev-python/PyMetno-0.8.3[${PYTHON_USEDEP}] )
	...
	met_eireann? ( ~dev-python/PyMetEireann-0.2[${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/millheater-0.4.0[${PYTHON_USEDEP}] )
	...
	modbus? ( ~dev-python/pymodbus-2.5.1[${PYTHON_USEDEP}] )
	modem_callerid? ( ~dev-python/basicmodem-0.7[${PYTHON_USEDEP}] )
	monoprice? ( ~dev-python/pymonoprice-0.3[${PYTHON_USEDEP}] )
	motioneye? ( ~dev-python/motioneye-client-0.3.6[${PYTHON_USEDEP}] )
	motion_blinds? ( ~dev-python/motionblinds-0.4.10[${PYTHON_USEDEP}] )
	...
	nanoleaf? ( ~dev-python/pynanoleaf-0.1.0[${PYTHON_USEDEP}] )
	neato? ( ~dev-python/pybotvac-0.0.20[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/python-nest-4.1.0[${PYTHON_USEDEP}] ~dev-python/google-nest-sdm-0.2.12[${PYTHON_USEDEP}] )
	...
	nexia? ( ~dev-python/nexia-0.9.6[${PYTHON_USEDEP}] )
	...
	norway_air? ( ~dev-python/PyMetno-0.8.3[${PYTHON_USEDEP}] )
	...
	onvif? ( ~dev-python/onvif-zeep-async-1.0.0[${PYTHON_USEDEP}] ~dev-python/WSDiscovery-2.0.0[${PYTHON_USEDEP}] ~dev-python/zeep-4.0.0[${PYTHON_USEDEP}] )
	...
	point? ( ~dev-python/pypoint-2.1.0[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-8.1.2[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-8.1.2[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	rflink? ( ~dev-python/rflink-0.0.58[${PYTHON_USEDEP}] )
	rfxtrx? ( ~dev-python/pyRFXtrx-0.26.1[${PYTHON_USEDEP}] )
	...
	rituals_perfume_genie? ( ~dev-python/pyrituals-0.0.2[${PYTHON_USEDEP}] )
	rmvtransport? ( ~dev-python/PyRMVtransport-0.3.1[${PYTHON_USEDEP}] )
	...
	sendgrid? ( ~dev-python/sendgrid-6.6.0[${PYTHON_USEDEP}] )
	sense? ( ~dev-python/sense-energy-0.9.0[${PYTHON_USEDEP}] )
	...
	serial? ( ~dev-python/pyserial-asyncio-0.5[${PYTHON_USEDEP}] )
	...
	seven_segments? ( ~dev-python/pillow-8.1.2[${PYTHON_USEDEP}] )
	...
	sighthound? ( ~dev-python/pillow-8.1.2[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	smarttub? ( ~dev-python/python-smarttub-0.0.24[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/defusedxml-0.6.0[${PYTHON_USEDEP}] ~dev-python/netdisco-2.8.2[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.16.2[${PYTHON_USEDEP}] )
	...
	stream? ( ~dev-python/av-8.0.3[${PYTHON_USEDEP}] )
	...
	surepetcare? ( ~dev-python/surepy-0.6.0[${PYTHON_USEDEP}] )
	...
	tado? ( ~dev-python/python-tado-0.10.0[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.16.2[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-1.20.2[${PYTHON_USEDEP}] )
	...
	twitter? ( ~dev-python/TwitterAPI-2.7.2[${PYTHON_USEDEP}] )
	...
	upcloud? ( ~dev-python/upcloud-api-1.0.1[${PYTHON_USEDEP}] )
	...
	venstar? ( ~dev-python/venstarcolortouch-0.13[${PYTHON_USEDEP}] )
	...
	vesync? ( ~dev-python/pyvesync-1.3.1[${PYTHON_USEDEP}] )
	...
	vlc_telnet? ( ~dev-python/python-telnet-vlc-2.0.1[${PYTHON_USEDEP}] )
	volkszaehler? ( ~dev-python/volkszaehler-0.2.1[${PYTHON_USEDEP}] )
	volumio? ( ~dev-python/pyvolumio-0.1.3[${PYTHON_USEDEP}] )
	...
	wilight? ( ~dev-python/pywilight-0.0.68[${PYTHON_USEDEP}] )
	...
	xmpp? ( ~dev-python/slixmpp-1.7.0[${PYTHON_USEDEP}] )
