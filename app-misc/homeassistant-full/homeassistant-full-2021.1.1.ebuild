...
RDEPEND="${RDEPEND}
	...
	cloud? ( ~dev-python/hass-nabucasa-0.39.0[${PYTHON_USEDEP}] )
	...
	hyperion? ( ~dev-python/hyperion-py-0.6.1[${PYTHON_USEDEP}] )
	...
	lastfm? ( ~dev-python/pylast-4.0.0[${PYTHON_USEDEP}] )
	launch_library? ( ~dev-python/pylaunches-1.0.0[${PYTHON_USEDEP}] )
	lcn? ( ~dev-python/pypck-0.7.7[${PYTHON_USEDEP}] )
	...
	mpd? ( ~dev-python/python-mpd2-3.0.1[${PYTHON_USEDEP}] )
	...
	neato? ( ~dev-python/pybotvac-0.0.19[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/python-nest-4.1.0[${PYTHON_USEDEP}] ~dev-python/google-nest-sdm-0.2.5[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-0.19.4[${PYTHON_USEDEP}] )
	...
	surepetcare? ( ~dev-python/surepy-0.2.6[${PYTHON_USEDEP}] )
	...
	twitter? ( ~dev-python/TwitterAPI-2.6.2.1[${PYTHON_USEDEP}] )
