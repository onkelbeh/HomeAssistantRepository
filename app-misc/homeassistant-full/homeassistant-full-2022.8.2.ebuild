...
RDEPEND="${RDEPEND}
	...
	govee_ble? ( ~dev-python/govee-ble-0.12.6[${PYTHON_USEDEP}] )
	...
	inkbird? ( ~dev-python/inkbird-ble-0.5.1[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.0.11[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.5[${PYTHON_USEDEP}] )
