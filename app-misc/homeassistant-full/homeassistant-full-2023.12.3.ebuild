...
RDEPEND="${RDEPEND}
	...
	aemet? ( ~dev-python/AEMET-OpenData-0.4.7[${PYTHON_USEDEP}] )
	...
	opensky? ( ~dev-python/python-opensky-0.2.1[${PYTHON_USEDEP}] )
	...
	schlage? ( ~dev-python/pyschlage-2023.12.0[${PYTHON_USEDEP}] )
