...
# Home Assistant Core dependencies from ./homeassistant-2025.2.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/hass-nabucasa-0.88.1[${PYTHON_USEDEP}]
	~dev-python/hassil-2.2.3[${PYTHON_USEDEP}]
	~dev-python/home-assistant-bluetooth-1.13.0[${PYTHON_USEDEP}]
	~dev-python/home-assistant-frontend-20250205.0[${PYTHON_USEDEP}]
...
# Home Assistant Core dependencies from ./core-2025.2.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	cloud? ( ~dev-python/hass-nabucasa-0.88.1[${PYTHON_USEDEP}] )
	...
	decora? ( ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/deebot-client-12.0.0[${PYTHON_USEDEP}] )
	decora_wifi? ( ~dev-python/deebot-client-12.0.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/deebot-client-12.0.0[${PYTHON_USEDEP}] ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	...
	enphase_envoy? ( ~dev-python/pyenphase-1.23.1[${PYTHON_USEDEP}] )
	...
	habitica? ( ~dev-python/habiticalib-0.3.5[${PYTHON_USEDEP}] )
	...
	heos? ( ~dev-python/pyheos-1.0.1[${PYTHON_USEDEP}] )
	...
	hydrawise? ( ~dev-python/pydrawise-2025.1.0[${PYTHON_USEDEP}] )
	...
	lacrosse_view? ( ~dev-python/lacrosse-view-1.0.4[${PYTHON_USEDEP}] )
	...
	shelly? ( ~dev-python/aioshelly-12.4.1[${PYTHON_USEDEP}] )
	...
	synology_dsm? ( ~dev-python/py-synologydsm-api-2.6.0[${PYTHON_USEDEP}] )
	...
	zeroconf? ( ~dev-python/zeroconf-0.143.0[${PYTHON_USEDEP}] )
