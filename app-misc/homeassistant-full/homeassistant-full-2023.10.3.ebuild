...
RDEPEND="${RDEPEND}
	...
	bthome? ( ~dev-python/bthome-ble-3.1.1[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.71.0[${PYTHON_USEDEP}] )
	...
	discovergy? ( ~dev-python/pydiscovergy-2.0.3[${PYTHON_USEDEP}] )
	...
	econet? ( ~dev-python/pyeconet-0.1.20[${PYTHON_USEDEP}] )
	...
	generic? ( ~dev-python/ha-av-10.1.1[${PYTHON_USEDEP}] ~dev-python/pillow-10.0.1[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/python-homewizard-energy-2.1.0[${PYTHON_USEDEP}] )
	...
	idasen_desk? ( ~dev-python/idasen-ha-1.4.1[${PYTHON_USEDEP}] )
	...
	matrix? ( ~dev-python/matrix-nio-0.21.2[${PYTHON_USEDEP}] ~dev-python/pillow-10.0.1[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/google-nest-sdm-3.0.2[${PYTHON_USEDEP}] )
	...
	nextdns? ( ~dev-python/nextdns-1.4.0[${PYTHON_USEDEP}] )
	nfandroidtv? ( ~dev-python/notifications-android-tv-0.1.5[${PYTHON_USEDEP}] )
	nibe_heatpump? ( ~dev-python/nibe-2.2.0[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.9.0[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-10.0.1[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-10.0.1[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	seven_segments? ( ~dev-python/pillow-10.0.1[${PYTHON_USEDEP}] )
	...
	sighthound? ( ~dev-python/pillow-10.0.1[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	switchbot_cloud? ( ~dev-python/switchbot-api-1.1.0[${PYTHON_USEDEP}] )
	...
	trafikverket_camera? ( ~dev-python/pytrafikverket-0.3.6[${PYTHON_USEDEP}] )
	trafikverket_ferry? ( ~dev-python/pytrafikverket-0.3.6[${PYTHON_USEDEP}] )
	trafikverket_train? ( ~dev-python/pytrafikverket-0.3.6[${PYTHON_USEDEP}] )
	trafikverket_weatherstation? ( ~dev-python/pytrafikverket-0.3.6[${PYTHON_USEDEP}] )
	...
	vodafone_station? ( ~dev-python/aiovodafone-0.3.1[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.3.0[${PYTHON_USEDEP}] )
