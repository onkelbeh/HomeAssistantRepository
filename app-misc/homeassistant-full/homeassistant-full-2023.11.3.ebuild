...
RDEPEND="${RDEPEND}
	...
	bosch_shc? ( ~dev-python/boschshcpy-0.2.75[${PYTHON_USEDEP}] )
	...
	comelit? ( ~dev-python/aiocomelit-0.5.2[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.0.1[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	...
	honeywell? ( ~dev-python/AIOSomecomfort-0.0.22[${PYTHON_USEDEP}] )
	...
	lupusec? ( ~dev-python/lupupy-0.3.1[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.13.2[${PYTHON_USEDEP}] )
	...
	subaru? ( ~dev-python/subarulink-0.7.9[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.21.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.7[${PYTHON_USEDEP}] )
