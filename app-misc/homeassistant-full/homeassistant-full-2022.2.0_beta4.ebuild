...
RDEPEND="${RDEPEND}
	...
	homewizard? ( ~dev-python/aiohwenergy-0.7.0[${PYTHON_USEDEP}] )
	...
	netgear? ( ~dev-python/pynetgear-0.9.0[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.3.1[${PYTHON_USEDEP}] )
	...
	tailscale? ( ~dev-python/tailscale-0.1.6[${PYTHON_USEDEP}] )
