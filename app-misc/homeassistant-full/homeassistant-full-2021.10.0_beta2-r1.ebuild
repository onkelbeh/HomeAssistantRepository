...
RDEPEND="${RDEPEND}
	...
	airthings? ( ~dev-python/airthings-cloud-0.0.1[${PYTHON_USEDEP}] )
	...
	crownstone? ( ~dev-python/crownstone-cloud-1.4.8[${PYTHON_USEDEP}] ~dev-python/crownstone-sse-2.0.2[${PYTHON_USEDEP}] ~dev-python/crownstone-uart-2.1.0[${PYTHON_USEDEP}] ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] )
	...
	debugpy? ( ~dev-python/debugpy-1.4.3[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.22.4[${PYTHON_USEDEP}] )
	...
	fjaraskupan? ( ~dev-python/fjaraskupan-1.0.1[${PYTHON_USEDEP}] )
	...
	folder_watcher? ( ~dev-python/watchdog-2.1.5[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-1.21.2[${PYTHON_USEDEP}] ~dev-python/pyiqvia-1.1.0[${PYTHON_USEDEP}] )
	...
	motion_blinds? ( ~dev-python/motionblinds-0.5.5[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-1.4.1[${PYTHON_USEDEP}] )
	...
	sia? ( ~dev-python/pysiaalarm-3.0.1[${PYTHON_USEDEP}] )
	...
	smarttub? ( ~dev-python/python-smarttub-0.0.27[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/async-upnp-client-0.22.4[${PYTHON_USEDEP}] )
	...
	system_bridge? ( ~dev-python/systembridge-2.1.0[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-1.21.2[${PYTHON_USEDEP}] )
