...
RDEPEND="${RDEPEND}
	...
	bosch_shc? ( ~dev-python/boschshcpy-0.2.17[${PYTHON_USEDEP}] )
	...
	discovery? ( ~dev-python/netdisco-2.8.3[${PYTHON_USEDEP}] )
	dlink? ( ~dev-python/pyW215-0.7.0[${PYTHON_USEDEP}] )
	dlna_dmr? ( ~dev-python/async-upnp-client-0.18.0[${PYTHON_USEDEP}] )
	...
	elgato? ( ~dev-python/elgato-2.1.0[${PYTHON_USEDEP}] )
	...
	folder_watcher? ( ~dev-python/watchdog-2.1.2[${PYTHON_USEDEP}] )
	...
	ialarm? ( ~dev-python/pyialarm-1.7[${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/millheater-0.4.1[${PYTHON_USEDEP}] )
	...
	nam? ( ~dev-python/nettigo-air-monitor-0.2.6[${PYTHON_USEDEP}] )
	...
	rituals_perfume_genie? ( ~dev-python/pyrituals-0.0.3[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/defusedxml-0.7.1[${PYTHON_USEDEP}] ~dev-python/netdisco-2.8.3[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.18.0[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.17.0[${PYTHON_USEDEP}] )
