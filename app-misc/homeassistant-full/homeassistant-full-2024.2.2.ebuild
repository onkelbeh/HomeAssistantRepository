...
RDEPEND="${RDEPEND}
	...
	airzone_cloud? ( ~dev-python/aioairzone-cloud-0.3.8[${PYTHON_USEDEP}] )
	...
	amazon_polly? ( ~dev-python/boto3-1.33.13[${PYTHON_USEDEP}] )
	...
	bang_olufsen? ( ~dev-python/mozart-api-3.2.1.150.6[${PYTHON_USEDEP}] )
	...
	bthome? ( ~dev-python/bthome-ble-3.5.0[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.76.0[${PYTHON_USEDEP}] )
	...
	comelit? ( ~dev-python/aiocomelit-0.8.3[${PYTHON_USEDEP}] )
	...
	duotecno? ( ~dev-python/pyDuotecno-2024.1.2[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/py-sucks-0.9.9[${PYTHON_USEDEP}] ~dev-python/deebot-client-5.2.1[${PYTHON_USEDEP}] )
	...
	govee_ble? ( ~dev-python/govee-ble-0.31.0[${PYTHON_USEDEP}] )
	govee_light_local? ( ~dev-python/govee-local-api-1.4.1[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/python-homewizard-energy-4.3.0[${PYTHON_USEDEP}] )
	...
	idasen_desk? ( ~dev-python/idasen-ha-2.5[${PYTHON_USEDEP}] )
	...
	jvc_projector? ( ~dev-python/pyjvcprojector-1.0.9[${PYTHON_USEDEP}] )
	...
	keymitt_ble? ( ~dev-python/PyMicroBot-0.0.12[${PYTHON_USEDEP}] )
	...
	lutron? ( ~dev-python/pylutron-0.2.12[${PYTHON_USEDEP}] )
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.19.0[${PYTHON_USEDEP}] )
	...
	motion_blinds? ( ~dev-python/motionblinds-0.6.20[${PYTHON_USEDEP}] )
	...
	myuplink? ( ~dev-python/myuplink-0.0.9[${PYTHON_USEDEP}] )
	...
	pegel_online? ( ~dev-python/aiopegelonline-0.0.8[${PYTHON_USEDEP}] )
	...
	rainforest_raven? ( ~dev-python/aioraven-0.5.0[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-1.39.2[${PYTHON_USEDEP}] )
	...
	songpal? ( ~dev-python/python-songpal-0.16.1[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/async-upnp-client-0.38.2[${PYTHON_USEDEP}] )
	...
	sunweg? ( ~dev-python/sunweg-2.1.0[${PYTHON_USEDEP}] )
	...
	switchbot_cloud? ( ~dev-python/switchbot-api-2.0.0[${PYTHON_USEDEP}] )
	...
	tedee? ( ~dev-python/pytedee-async-0.2.13[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-0.2.3[${PYTHON_USEDEP}] )
	...
	thermopro? ( ~dev-python/thermopro-ble-0.9.0[${PYTHON_USEDEP}] )
	...
	traccar_server? ( ~dev-python/pytraccar-2.0.0[${PYTHON_USEDEP}] )
	...
	xiaomi_ble? ( ~dev-python/xiaomi-ble-0.23.1[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.4.1[${PYTHON_USEDEP}] )
	...
	zamg? ( ~dev-python/zamg-0.3.5[${PYTHON_USEDEP}] )
