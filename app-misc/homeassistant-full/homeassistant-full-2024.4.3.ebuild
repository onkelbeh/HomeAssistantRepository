...
RDEPEND="${RDEPEND}
	...
	airzone_cloud? ( ~dev-python/aioairzone-cloud-0.4.7[${PYTHON_USEDEP}] )
	...
	duotecno? ( ~dev-python/pyDuotecno-2024.3.2[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/python-homewizard-energy-5.0.0[${PYTHON_USEDEP}] )
	...
	husqvarna_automower? ( ~dev-python/aioautomower-2024.3.4[${PYTHON_USEDEP}] )
	...
	ondilo_ico? ( ~dev-python/ondilo-0.4.0[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.4.3[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.13.9[${PYTHON_USEDEP}] )
	...
	risco? ( ~dev-python/pyrisco-0.6.0[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-0.4.9[${PYTHON_USEDEP}] )
	...
	weatherflow_cloud? ( ~dev-python/weatherflow4py-0.2.20[${PYTHON_USEDEP}] )
