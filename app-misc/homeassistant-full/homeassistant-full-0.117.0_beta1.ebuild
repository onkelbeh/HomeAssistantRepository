...
RDEPEND="${RDEPEND}
	...
	cloudflare? ( ~dev-python/pycfdns-1.1.1[${PYTHON_USEDEP}] )
	...
	frontend? ( ~dev-python/home-assistant-frontend-20201021.1[${PYTHON_USEDEP}] )
	...
	gree? ( ~dev-python/greeclimate-0.9.0[${PYTHON_USEDEP}] )
	...
	hyperion? ( ~dev-python/hyperion-py-0.3.0[${PYTHON_USEDEP}] )
	...
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.7.0[${PYTHON_USEDEP}] )
	...
	opencv? ( ~dev-python/numpy-1.19.2[${PYTHON_USEDEP}] )
	...
	rpi_gpio_pwm? ( ~dev-python/pwmled-1.5.3[${PYTHON_USEDEP}] )
	...
	spotify? ( ~dev-python/spotipy-2.16.0[${PYTHON_USEDEP}] )
	...
	tasmota? ( ~dev-python/HATasmota-0.0.19[${PYTHON_USEDEP}] )
	...
	tensorflow? ( ~dev-python/pycocotools-2.0.1[${PYTHON_USEDEP}] ~dev-python/numpy-1.19.2[${PYTHON_USEDEP}] ~dev-python/pillow-7.2.0[${PYTHON_USEDEP}] )
