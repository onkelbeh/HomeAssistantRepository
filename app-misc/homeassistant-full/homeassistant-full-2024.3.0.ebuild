...
RDEPEND="${RDEPEND}
	...
	aemet? ( ~dev-python/AEMET-OpenData-0.5.1[${PYTHON_USEDEP}] )
	...
	airzone_cloud? ( ~dev-python/aioairzone-cloud-0.4.5[${PYTHON_USEDEP}] )
	...
	bthome? ( ~dev-python/bthome-ble-3.6.0[${PYTHON_USEDEP}] )
	...
	discovergy? ( ~dev-python/pydiscovergy-3.0.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/py-sucks-0.9.9[${PYTHON_USEDEP}] ~dev-python/deebot-client-6.0.2[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.0.3[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-7.0.0[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/python-homewizard-energy-4.3.1[${PYTHON_USEDEP}] )
	...
	hunterdouglas_powerview? ( ~dev-python/aiopvapi-3.0.2[${PYTHON_USEDEP}] )
	husqvarna_automower? ( ~dev-python/aioautomower-2024.2.10[${PYTHON_USEDEP}] )
	...
	idasen_desk? ( ~dev-python/idasen-ha-2.5.1[${PYTHON_USEDEP}] )
	...
	myuplink? ( ~dev-python/myuplink-0.5.0[${PYTHON_USEDEP}] )
	...
	notion? ( ~dev-python/aionotion-2024.2.2[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.13.8[${PYTHON_USEDEP}] )
	...
	pegel_online? ( ~dev-python/aiopegelonline-0.0.9[${PYTHON_USEDEP}] )
	...
	rainforest_raven? ( ~dev-python/aioraven-0.5.1[${PYTHON_USEDEP}] )
	...
	rfxtrx? ( ~dev-python/pyRFXtrx-0.31.0[${PYTHON_USEDEP}] )
	...
	rova? ( ~dev-python/rova-0.4.0[${PYTHON_USEDEP}] )
	...
	tedee? ( ~dev-python/pytedee-async-0.2.15[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/tesla-fleet-api-0.4.6[${PYTHON_USEDEP}] )
	...
	tplink_omada? ( ~dev-python/tplink-omada-client-1.3.11[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.23.3[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.8[${PYTHON_USEDEP}] )
	...
	weatherflow_cloud? ( ~dev-python/weatherflow4py-0.1.12[${PYTHON_USEDEP}] )
	weatherkit? ( ~dev-python/apple_weatherkit-1.1.2[${PYTHON_USEDEP}] )
	webmin? ( ~dev-python/webmin-xmlrpc-0.0.1[${PYTHON_USEDEP}] )
	...
	wolflink? ( ~dev-python/wolf-comm-0.0.6[${PYTHON_USEDEP}] )
	...
	xiaomi_ble? ( ~dev-python/xiaomi-ble-0.25.2[${PYTHON_USEDEP}] )
	...
	yolink? ( ~dev-python/yolink-api-0.3.7[${PYTHON_USEDEP}] )
