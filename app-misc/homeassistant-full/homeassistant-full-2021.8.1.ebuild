...
RDEPEND="${RDEPEND}
	...
	adax? ( ~dev-python/adax-0.0.1[${PYTHON_USEDEP}] )
	...
	debugpy? ( ~dev-python/debugpy-1.4.0[${PYTHON_USEDEP}] )
	...
	forecast_solar? ( ~dev-python/forecast-solar-2.0.0[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-1.21.1[${PYTHON_USEDEP}] ~dev-python/pyiqvia-1.0.0[${PYTHON_USEDEP}] )
	...
	litterrobot? ( ~dev-python/pylitterbot-2021.7.2[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/python-nest-4.1.0[${PYTHON_USEDEP}] ~dev-python/google-nest-sdm-0.3.5[${PYTHON_USEDEP}] )
	...
	recollect_waste? ( ~dev-python/aiorecollect-1.0.7[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-1.3.0[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.19.0[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-1.21.1[${PYTHON_USEDEP}] )
	...
	wirelesstag? ( ~dev-python/wirelesstagpy-0.5.0[${PYTHON_USEDEP}] )
