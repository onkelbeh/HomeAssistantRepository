...
RDEPEND="${RDEPEND}
	...
	doods? ( ~dev-python/pydoods-1.0.2[${PYTHON_USEDEP}] ~dev-python/pillow-8.1.0[${PYTHON_USEDEP}] )
	...
	emulated_kasa? ( ~dev-python/sense-energy-0.8.1[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/google-api-python-client-1.6.4[${PYTHON_USEDEP}] ~dev-python/httplib2-0.18.1[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.0.0[${PYTHON_USEDEP}] )
	...
	image? ( ~dev-python/pillow-8.1.0[${PYTHON_USEDEP}] )
	...
	isy994? ( ~dev-python/pyisy-2.1.0[${PYTHON_USEDEP}] )
	...
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.9.0[${PYTHON_USEDEP}] ~dev-python/aiolip-1.0.1[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/python-nest-4.1.0[${PYTHON_USEDEP}] ~dev-python/google-nest-sdm-0.2.9[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-8.1.0[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-8.1.0[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	remember_the_milk? ( ~dev-python/RtmAPI-0.7.2[${PYTHON_USEDEP}] ~dev-python/httplib2-0.18.1[${PYTHON_USEDEP}] )
	...
	rmvtransport? ( ~dev-python/PyRMVtransport-0.2.10[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-0.19.5[${PYTHON_USEDEP}] )
	...
	seven_segments? ( ~dev-python/pillow-8.1.0[${PYTHON_USEDEP}] )
	...
	sighthound? ( ~dev-python/pillow-8.1.0[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	twitter? ( ~dev-python/TwitterAPI-2.6.3[${PYTHON_USEDEP}] )
	...
	verisure? ( ~dev-python/jsonpath-0.82[${PYTHON_USEDEP}] ~dev-python/vsure-1.6.1[${PYTHON_USEDEP}] )
	...
	wilight? ( ~dev-python/pywilight-0.0.66[${PYTHON_USEDEP}] )
	...
	xmpp? ( ~dev-python/slixmpp-1.6.0[${PYTHON_USEDEP}] )
