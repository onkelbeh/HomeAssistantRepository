...
RDEPEND="${RDEPEND}
	...
	aemet? ( ~dev-python/AEMET-OpenData-0.4.6[${PYTHON_USEDEP}] )
	...
	airq? ( ~dev-python/aioairq-0.3.1[${PYTHON_USEDEP}] )
	...
	airzone_cloud? ( ~dev-python/aioairzone-cloud-0.3.6[${PYTHON_USEDEP}] )
	...
	comelit? ( ~dev-python/aiocomelit-0.6.2[${PYTHON_USEDEP}] )
	...
	devialet? ( ~dev-python/devialet-1.4.3[${PYTHON_USEDEP}] )
	...
	duotecno? ( ~dev-python/pyDuotecno-2023.11.1[${PYTHON_USEDEP}] )
	...
	easyenergy? ( ~dev-python/easyenergy-1.0.0[${PYTHON_USEDEP}] )
	...
	elgato? ( ~dev-python/elgato-5.1.1[${PYTHON_USEDEP}] )
	...
	energyzero? ( ~dev-python/energyzero-1.0.0[${PYTHON_USEDEP}] )
	...
	garages_amsterdam? ( ~dev-python/odp-amsterdam-6.0.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.0.3[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/python-homewizard-energy-4.1.0[${PYTHON_USEDEP}] )
	...
	honeywell? ( ~dev-python/AIOSomecomfort-0.0.24[${PYTHON_USEDEP}] )
	...
	idasen_desk? ( ~dev-python/idasen-ha-2.4[${PYTHON_USEDEP}] )
	...
	ld2410_ble? ( ~dev-python/bluetooth-data-tools-1.15.0[${PYTHON_USEDEP}] ~dev-python/ld2410-ble-0.1.1[${PYTHON_USEDEP}] )
	led_ble? ( ~dev-python/bluetooth-data-tools-1.15.0[${PYTHON_USEDEP}] ~dev-python/led-ble-1.0.1[${PYTHON_USEDEP}] )
	...
	linear_garage_door? ( ~dev-python/linear-garage-door-0.2.7[${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/millheater-0.11.7[${PYTHON_USEDEP}] ~dev-python/mill-local-0.3.0[${PYTHON_USEDEP}] )
	...
	mopeka? ( ~dev-python/mopeka-iot-ble-0.5.0[${PYTHON_USEDEP}] )
	...
	nextdns? ( ~dev-python/nextdns-2.1.0[${PYTHON_USEDEP}] )
	nfandroidtv? ( ~dev-python/notifications-android-tv-0.1.5[${PYTHON_USEDEP}] )
	nibe_heatpump? ( ~dev-python/nibe-2.5.2[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.13.3[${PYTHON_USEDEP}] )
	...
	permobil? ( ~dev-python/mypermobil-0.1.6[${PYTHON_USEDEP}] )
	...
	private_ble_device? ( ~dev-python/bluetooth-data-tools-1.15.0[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.8.2[${PYTHON_USEDEP}] )
	...
	risco? ( ~dev-python/pyrisco-0.5.8[${PYTHON_USEDEP}] )
	...
	schlage? ( ~dev-python/pyschlage-2023.11.0[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-1.37.1[${PYTHON_USEDEP}] )
	...
	songpal? ( ~dev-python/python-songpal-0.16[${PYTHON_USEDEP}] )
	...
	system_bridge? ( ~dev-python/systembridgeconnector-3.10.0[${PYTHON_USEDEP}] )
	...
	thermopro? ( ~dev-python/thermopro-ble-0.5.0[${PYTHON_USEDEP}] )
	...
	traccar? ( ~dev-python/pytraccar-2.0.0[${PYTHON_USEDEP}] ~dev-python/stringcase-1.2.0[${PYTHON_USEDEP}] )
	...
	trafikverket_camera? ( ~dev-python/pytrafikverket-0.3.9.1[${PYTHON_USEDEP}] )
	trafikverket_ferry? ( ~dev-python/pytrafikverket-0.3.9.1[${PYTHON_USEDEP}] )
	trafikverket_train? ( ~dev-python/pytrafikverket-0.3.9.1[${PYTHON_USEDEP}] )
	trafikverket_weatherstation? ( ~dev-python/pytrafikverket-0.3.9.1[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.22.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.7[${PYTHON_USEDEP}] )
	...
	vodafone_station? ( ~dev-python/aiovodafone-0.4.3[${PYTHON_USEDEP}] )
	...
	yolink? ( ~dev-python/yolink-api-0.3.4[${PYTHON_USEDEP}] )
	...
	zamg? ( ~dev-python/zamg-0.3.3[${PYTHON_USEDEP}] )
