...
RDEPEND="${RDEPEND}
	...
	generic? ( ~dev-python/ha-av-10.0.0_beta5[${PYTHON_USEDEP}] ~dev-python/pillow-9.2.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-2.2.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	...
	huawei_lte? ( ~dev-python/huawei-lte-api-1.6.3[${PYTHON_USEDEP}] ~dev-python/stringcase-1.2.0[${PYTHON_USEDEP}] ~dev-python/url-normalize-1.4.3[${PYTHON_USEDEP}] )
	hue? ( ~dev-python/aiohue-4.5.0[${PYTHON_USEDEP}] )
	huisbaasje? ( ~dev-python/energyflip-client-0.2.1[${PYTHON_USEDEP}] )
	hunterdouglas_powerview? ( ~dev-python/aiopvapi-2.0.3[${PYTHON_USEDEP}] )
	...
	landisgyr_heat_meter? ( ~dev-python/ultraheat-api-0.5.0[${PYTHON_USEDEP}] )
	...
	lupusec? ( ~dev-python/lupupy-0.1.9[${PYTHON_USEDEP}] )
	...
	opentherm_gw? ( ~dev-python/pyotgw-2.1.1[${PYTHON_USEDEP}] )
	...
	oralb? ( ~dev-python/oralb-ble-0.9.0[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.5.6[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-1.10.0[${PYTHON_USEDEP}] )
	...
	snooz? ( ~dev-python/pysnooz-0.8.2[${PYTHON_USEDEP}] )
	...
	stream? ( ~dev-python/PyTurboJPEG-1.6.7[${PYTHON_USEDEP}] ~dev-python/ha-av-10.0.0_beta5[${PYTHON_USEDEP}] )
	streamlabswater? ( ~dev-python/streamlabswater-1.0.1[${PYTHON_USEDEP}] )
	subaru? ( ~dev-python/subarulink-0.6.1[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.20.2[${PYTHON_USEDEP}] )
	switcher_kis? ( ~dev-python/aioswitcher-3.1.0[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.25.6[${PYTHON_USEDEP}] )
	...
	trafikverket_ferry? ( ~dev-python/pytrafikverket-0.2.1[${PYTHON_USEDEP}] )
	trafikverket_train? ( ~dev-python/pytrafikverket-0.2.1[${PYTHON_USEDEP}] )
	trafikverket_weatherstation? ( ~dev-python/pytrafikverket-0.2.1[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.3.4[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.7[${PYTHON_USEDEP}] )
	...
	wallbox? ( ~dev-python/wallbox-0.4.10[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-1.9.4[${PYTHON_USEDEP}] )
