...
RDEPEND="${RDEPEND}
	...
	debugpy? ( ~dev-python/debugpy-1.5.0[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.22.10[${PYTHON_USEDEP}] )
	...
	ezviz? ( ~dev-python/pyEzviz-0.1.9.4[${PYTHON_USEDEP}] )
	...
	honeywell? ( ~dev-python/somecomfort-0.7.0[${PYTHON_USEDEP}] )
	...
	met? ( ~dev-python/PyMetno-0.8.4[${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/millheater-0.7.4[${PYTHON_USEDEP}] )
	...
	nam? ( ~dev-python/nettigo-air-monitor-1.1.1[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/python-nest-4.1.0[${PYTHON_USEDEP}] ~dev-python/google-nest-sdm-0.3.8[${PYTHON_USEDEP}] )
	...
	norway_air? ( ~dev-python/PyMetno-0.8.4[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-1.4.3[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/async-upnp-client-0.22.10[${PYTHON_USEDEP}] )
	...
	system_bridge? ( ~dev-python/systembridge-2.1.3[${PYTHON_USEDEP}] )
	...
	tautulli? ( ~dev-python/pytautulli-21.10.0[${PYTHON_USEDEP}] )
