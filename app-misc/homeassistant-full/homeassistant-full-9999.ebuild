...
RDEPEND="${RDEPEND}
	...
	duotecno? ( ~dev-python/pyDuotecno-2024.5.0[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/py-sucks-0.9.9[${PYTHON_USEDEP}] ~dev-python/deebot-client-7.2.0[${PYTHON_USEDEP}] )
	...
	eq3btsmart? ( ~dev-python/eq3btsmart-1.1.6[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-1.0.0[${PYTHON_USEDEP}] )
	...
	goodwe? ( ~dev-python/goodwe-0.3.5[${PYTHON_USEDEP}] )
	...
	govee_light_local? ( ~dev-python/govee-local-api-1.4.5[${PYTHON_USEDEP}] )
	...
	husqvarna_automower? ( ~dev-python/aioautomower-2024.4.3[${PYTHON_USEDEP}] )
	...
	nam? ( ~dev-python/nettigo-air-monitor-3.0.0[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/google-nest-sdm-3.0.4[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.4.4[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.13.10[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.8.10[${PYTHON_USEDEP}] )
	...
	v2c? ( ~dev-python/pytrydan-0.6.0[${PYTHON_USEDEP}] )
