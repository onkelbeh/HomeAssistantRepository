...
RDEPEND="${RDEPEND}
	...
	eq3btsmart? ( ~dev-python/eq3btsmart-1.1.9[${PYTHON_USEDEP}] ~dev-python/bleak-esphome-1.0.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.1.6[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] ~dev-python/ical-8.2.0[${PYTHON_USEDEP}] )
	...
	tesla_fleet? ( ~dev-python/tesla-fleet-api-0.7.8[${PYTHON_USEDEP}] )
	...
	tessie? ( ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-0.7.8[${PYTHON_USEDEP}] )
