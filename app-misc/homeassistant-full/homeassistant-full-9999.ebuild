...
RDEPEND="${RDEPEND}
	...
	google? ( ~dev-python/gcal-sync-4.0.2[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	...
	oralb? ( ~dev-python/oralb-ble-0.14.2[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.20.5[${PYTHON_USEDEP}] )
