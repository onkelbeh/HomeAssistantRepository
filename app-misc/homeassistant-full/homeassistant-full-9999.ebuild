...
RDEPEND="${RDEPEND}
	...
	adax? ( ~dev-python/adax-0.2.0[${PYTHON_USEDEP}] ~dev-python/Adax-local-0.1.3[${PYTHON_USEDEP}] )
	adguard? ( ~dev-python/adguardhome-0.5.1[${PYTHON_USEDEP}] )
	ads? ( ~dev-python/pyads-3.2.2[${PYTHON_USEDEP}] )
	advantage_air? ( ~dev-python/advantage-air-0.2.5[${PYTHON_USEDEP}] )
	...
	amberelectric? ( ~dev-python/amberelectric-1.0.3[${PYTHON_USEDEP}] )
	...
	aseko_pool_live? ( ~dev-python/aioaseko-0.0.1[${PYTHON_USEDEP}] )
	...
	aussie_broadband? ( ~dev-python/pyaussiebb-0.0.9[${PYTHON_USEDEP}] )
	...
	bosch_shc? ( ~dev-python/boschshcpy-0.2.28[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.52.0[${PYTHON_USEDEP}] )
	...
	crownstone? ( ~dev-python/crownstone-cloud-1.4.9[${PYTHON_USEDEP}] ~dev-python/crownstone-sse-2.0.3[${PYTHON_USEDEP}] ~dev-python/crownstone-uart-2.1.0[${PYTHON_USEDEP}] ~dev-python/pyserial-3.5[${PYTHON_USEDEP}] )
	...
	debugpy? ( ~dev-python/debugpy-1.5.1[${PYTHON_USEDEP}] )
	...
	devolo_home_network? ( ~dev-python/devolo-plc-api-0.7.1[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.23.4[${PYTHON_USEDEP}] )
	dnsip? ( ~dev-python/aiodns-3.0.0[${PYTHON_USEDEP}] )
	dominos? ( ~dev-python/pizzapi-0.0.3[${PYTHON_USEDEP}] )
	doods? ( ~dev-python/pydoods-1.0.2[${PYTHON_USEDEP}] ~dev-python/pillow-9.0.0[${PYTHON_USEDEP}] )
	doorbird? ( ~dev-python/DoorBirdPy-2.1.0[${PYTHON_USEDEP}] )
	dovado? ( ~dev-python/dovado-0.4.1[${PYTHON_USEDEP}] )
	dsmr? ( ~dev-python/dsmr-parser-0.32[${PYTHON_USEDEP}] )
	...
	econet? ( ~dev-python/pyeconet-0.1.14[${PYTHON_USEDEP}] )
	...
	emulated_kasa? ( ~dev-python/sense-energy-0.9.6[${PYTHON_USEDEP}] )
	...
	entur_public_transport? ( ~dev-python/enturclient-0.2.3[${PYTHON_USEDEP}] )
	...
	envisalink? ( ~dev-python/pyenvisalink-4.3[${PYTHON_USEDEP}] )
	ephember? ( ~dev-python/pyephember-0.3.1[${PYTHON_USEDEP}] )
	epson? ( ~dev-python/epson-projector-0.4.2[${PYTHON_USEDEP}] )
	epsonworkforce? ( ~dev-python/epsonprinter-0.0.9[${PYTHON_USEDEP}] )
	eq3btsmart? ( ~dev-python/construct-2.10.56[${PYTHON_USEDEP}] ~dev-python/python-eq3bt-0.1.11[${PYTHON_USEDEP}] )
	...
	evil_genius_labs? ( ~dev-python/pyevilgenius-1.0.0[${PYTHON_USEDEP}] )
	...
	feedreader? ( ~dev-python/feedparser-6.0.2[${PYTHON_USEDEP}] )
	...
	fjaraskupan? ( ~dev-python/fjaraskupan-1.0.2[${PYTHON_USEDEP}] )
	...
	gdacs? ( ~dev-python/aio-georss-gdacs-0.5[${PYTHON_USEDEP}] )
	...
	glances? ( ~dev-python/glances-api-0.3.4[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/google-api-python-client-1.6.4[${PYTHON_USEDEP}] ~dev-python/httplib2-0.19.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	google_cloud? ( ~dev-python/google-cloud-texttospeech-0.4.0[${PYTHON_USEDEP}] )
	google_maps? ( ~dev-python/locationsharinglib-4.1.5[${PYTHON_USEDEP}] )
	google_pubsub? ( ~dev-python/google-cloud-pubsub-2.9.0[${PYTHON_USEDEP}] )
	google_translate? ( ~dev-python/gTTS-2.2.3[${PYTHON_USEDEP}] )
	...
	gree? ( ~dev-python/greeclimate-1.0.2[${PYTHON_USEDEP}] )
	...
	hangouts? ( ~dev-python/hangups-0.4.17[${PYTHON_USEDEP}] )
	...
	homewizard? ( ~dev-python/aiohwenergy-0.8.0[${PYTHON_USEDEP}] )
	...
	intellifire? ( ~dev-python/intellifire4py-0.5[${PYTHON_USEDEP}] )
	...
	iqvia? ( ~dev-python/numpy-1.21.4[${PYTHON_USEDEP}] ~dev-python/pyiqvia-2021.11.0[${PYTHON_USEDEP}] )
	...
	isy994? ( ~dev-python/pyisy-3.0.1[${PYTHON_USEDEP}] )
	...
	juicenet? ( ~dev-python/python-juicenet-1.0.2[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/pypck-0.7.13[${PYTHON_USEDEP}] )
	...
	lookin? ( ~dev-python/aiolookin-0.1.0[${PYTHON_USEDEP}] )
	...
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.13.0[${PYTHON_USEDEP}] )
	...
	mazda? ( ~dev-python/pymazda-0.3.2[${PYTHON_USEDEP}] )
	...
	melcloud? ( ~dev-python/pymelcloud-2.5.6[${PYTHON_USEDEP}] )
	...
	meteoalarm? ( ~dev-python/meteoalertapi-0.2.0[${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/millheater-0.9.0[${PYTHON_USEDEP}] ~dev-python/mill-local-0.1.1[${PYTHON_USEDEP}] )
	...
	modbus? ( ~dev-python/pymodbus-2.5.3_rc1[${PYTHON_USEDEP}] )
	...
	motion_blinds? ( ~dev-python/motionblinds-0.5.10[${PYTHON_USEDEP}] )
	...
	nam? ( ~dev-python/nettigo-air-monitor-1.2.1[${PYTHON_USEDEP}] )
	namecheapdns? ( ~dev-python/defusedxml-0.7.1[${PYTHON_USEDEP}] )
	nanoleaf? ( ~dev-python/aionanoleaf-0.1.1[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/python-nest-4.1.0[${PYTHON_USEDEP}] ~dev-python/google-nest-sdm-1.6.0[${PYTHON_USEDEP}] )
	netatmo? ( ~dev-python/pyatmo-6.2.4[${PYTHON_USEDEP}] )
	netdata? ( ~dev-python/netdata-1.0.1[${PYTHON_USEDEP}] )
	netgear? ( ~dev-python/pynetgear-0.9.1[${PYTHON_USEDEP}] )
	...
	nexia? ( ~dev-python/nexia-0.9.13[${PYTHON_USEDEP}] )
	nextbus? ( ~dev-python/py-nextbusnext-0.1.5[${PYTHON_USEDEP}] )
	nextcloud? ( ~dev-python/nextcloudmonitor-1.1.0[${PYTHON_USEDEP}] )
	nfandroidtv? ( ~dev-python/notifications-android-tv-0.1.3[${PYTHON_USEDEP}] )
	...
	nina? ( ~dev-python/PyNINA-0.1.4[${PYTHON_USEDEP}] )
	...
	obihai? ( ~dev-python/pyobihai-1.3.1[${PYTHON_USEDEP}] )
	...
	oncue? ( ~dev-python/aiooncue-0.3.2[${PYTHON_USEDEP}] )
	ondilo_ico? ( ~dev-python/ondilo-0.2.0[${PYTHON_USEDEP}] )
	onewire? ( ~dev-python/pyownet-0.10.0[${PYTHON_USEDEP}] ~dev-python/pi1wire-0.1.0[${PYTHON_USEDEP}] )
	...
	overkiz? ( ~dev-python/pyoverkiz-1.3.2[${PYTHON_USEDEP}] )
	ovo_energy? ( ~dev-python/ovoenergy-1.1.12[${PYTHON_USEDEP}] )
	owntracks? ( ~dev-python/pynacl-1.4.0[${PYTHON_USEDEP}] )
	ozw? ( ~dev-python/python-openzwave-mqtt-1.4.0[${PYTHON_USEDEP}] )
	p1_monitor? ( ~dev-python/p1monitor-1.0.1[${PYTHON_USEDEP}] )
	...
	profiler? ( ~dev-python/pyprof2calltree-1.4.5[${PYTHON_USEDEP}] ~dev-python/guppy3-3.1.2[${PYTHON_USEDEP}] ~dev-python/objgraph-3.4.1[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-9.0.0[${PYTHON_USEDEP}] )
	...
	pvoutput? ( ~dev-python/pvo-0.2.0[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-9.0.0[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	rainforest_eagle? ( ~dev-python/aioeagle-1.1.0[${PYTHON_USEDEP}] ~dev-python/uEagle-0.0.2[${PYTHON_USEDEP}] )
	...
	rdw? ( ~dev-python/vehicle-0.3.1[${PYTHON_USEDEP}] )
	...
	remember_the_milk? ( ~dev-python/RtmAPI-0.7.2[${PYTHON_USEDEP}] ~dev-python/httplib2-0.19.0[${PYTHON_USEDEP}] )
	remote_rpi_gpio? ( ~dev-python/gpiozero-1.5.1[${PYTHON_USEDEP}] )
	renault? ( ~dev-python/renault-api-0.1.7[${PYTHON_USEDEP}] )
	...
	rfxtrx? ( ~dev-python/pyRFXtrx-0.27.1[${PYTHON_USEDEP}] )
	ridwell? ( ~dev-python/aioridwell-2021.12.2[${PYTHON_USEDEP}] )
	...
	rtsp_to_webrtc? ( ~dev-python/rtsp-to-webrtc-0.5.0[${PYTHON_USEDEP}] )
	ruckus_unleashed? ( ~dev-python/pyruckus-0.12[${PYTHON_USEDEP}] )
	...
	sense? ( ~dev-python/sense-energy-0.9.6[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-1.5.3[${PYTHON_USEDEP}] )
	...
	seven_segments? ( ~dev-python/pillow-9.0.0[${PYTHON_USEDEP}] )
	...
	sighthound? ( ~dev-python/pillow-9.0.0[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/async-upnp-client-0.23.4[${PYTHON_USEDEP}] )
	...
	stream? ( ~dev-python/PyTurboJPEG-1.6.5[${PYTHON_USEDEP}] ~dev-python/av-8.1.0[${PYTHON_USEDEP}] )
	...
	syncthru? ( ~dev-python/PySyncThru-0.7.10[${PYTHON_USEDEP}] ~dev-python/url-normalize-1.4.1[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.21.7[${PYTHON_USEDEP}] )
	...
	tractive? ( ~dev-python/aiotractive-0.5.2[${PYTHON_USEDEP}] )
	...
	twinkly? ( ~dev-python/ttls-1.4.2[${PYTHON_USEDEP}] )
	twitch? ( ~dev-python/python-twitch-client-0.6.0[${PYTHON_USEDEP}] )
	twitter? ( ~dev-python/TwitterAPI-2.7.5[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-3.2.0[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.2[${PYTHON_USEDEP}] )
	...
	uptimerobot? ( ~dev-python/pyuptimerobot-21.11.0[${PYTHON_USEDEP}] )
	...
	volkszaehler? ( ~dev-python/volkszaehler-0.2.1[${PYTHON_USEDEP}] )
	volumio? ( ~dev-python/pyvolumio-0.1.5[${PYTHON_USEDEP}] )
	volvooncall? ( ~dev-python/volvooncall-0.9.1[${PYTHON_USEDEP}] )
	...
	wallbox? ( ~dev-python/wallbox-0.4.4[${PYTHON_USEDEP}] )
	...
	xmpp? ( ~dev-python/slixmpp-1.7.1[${PYTHON_USEDEP}] )
	xs1? ( ~dev-python/xs1-api-client-3.0.0[${PYTHON_USEDEP}] )
	yale_smart_alarm? ( ~dev-python/yalesmartalarmclient-0.3.7[${PYTHON_USEDEP}] )
