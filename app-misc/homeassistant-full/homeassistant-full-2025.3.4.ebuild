...
RDEPEND="${RDEPEND}
	...
	evohome? ( ~dev-python/evohome-async-1.0.4[${PYTHON_USEDEP}] )
	...
	govee_ble? ( ~dev-python/govee-ble-0.43.1[${PYTHON_USEDEP}] )
	...
	heos? ( ~dev-python/pyheos-1.0.3[${PYTHON_USEDEP}] )
	...
	keyboard_remote? ( ~dev-python/asyncinotify-4.2.0[${PYTHON_USEDEP}] ~dev-python/evohome-async-1.0.4[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2025.1.30.194235[${PYTHON_USEDEP}] ~dev-python/xknx-3.6.0[${PYTHON_USEDEP}] ~dev-python/xknxproject-3.8.2[${PYTHON_USEDEP}] )
	...
	lamarzocco? ( ~dev-python/pylamarzocco-1.4.9[${PYTHON_USEDEP}] )
	...
	roborock? ( ~dev-python/python-roborock-2.12.2[${PYTHON_USEDEP}] ~dev-python/vacuum-map-parser-roborock-0.1.2[${PYTHON_USEDEP}] )
	...
	smartthings? ( ~dev-python/pysmartthings-2.7.4[${PYTHON_USEDEP}] )
	...
	snoo? ( ~dev-python/python-snoo-0.6.4[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.57.1[${PYTHON_USEDEP}] )
	...
	tensorflow? ( ~dev-python/pillow-11.1.0[${PYTHON_USEDEP}] ~dev-python/numpy-2.2.2[${PYTHON_USEDEP}] ~dev-python/pycomfoconnect-0.5.1[${PYTHON_USEDEP}] ~dev-python/tesla-fleet-api-0.9.13[${PYTHON_USEDEP}] ~dev-python/thermobeacon-ble-0.8.1[${PYTHON_USEDEP}] )
	tesla_fleet? ( ~dev-python/tesla-fleet-api-0.9.13[${PYTHON_USEDEP}] )
	tesla_wall_connector? ( ~dev-python/tesla-wall-connector-1.0.2[${PYTHON_USEDEP}] )
	teslemetry? ( ~dev-python/tesla-fleet-api-0.9.13[${PYTHON_USEDEP}] ~dev-python/teslemetry-stream-0.6.12[${PYTHON_USEDEP}] )
	tessie? ( ~dev-python/tesla-fleet-api-0.9.13[${PYTHON_USEDEP}] ~dev-python/tessie-api-0.1.1[${PYTHON_USEDEP}] )
	...
	velbus? ( ~dev-python/velbus-aio-2025.3.1[${PYTHON_USEDEP}] )
	...
	webdav? ( ~dev-python/aiowebdav2-0.4.2[${PYTHON_USEDEP}] )
	...
	zengge? ( ~dev-python/bluetooth-adapters-0.21.4[${PYTHON_USEDEP}] ~dev-python/zengge-0.2[${PYTHON_USEDEP}] )
	...
	zha? ( ~dev-python/zha-0.0.53[${PYTHON_USEDEP}] )
