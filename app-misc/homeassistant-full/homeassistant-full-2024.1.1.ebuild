...
RDEPEND="${RDEPEND}
	...
	aosmith? ( ~dev-python/py-aosmith-1.0.1[${PYTHON_USEDEP}] )
	...
	blue_current? ( ~dev-python/bluecurrent-api-1.0.6[${PYTHON_USEDEP}] )
	...
	bthome? ( ~dev-python/bthome-ble-3.3.1[${PYTHON_USEDEP}] )
	...
	cloud? ( ~dev-python/hass-nabucasa-0.75.1[${PYTHON_USEDEP}] )
	...
	comelit? ( ~dev-python/aiocomelit-0.7.0[${PYTHON_USEDEP}] )
	...
	drop_connect? ( ~dev-python/dropmqttapi-1.0.2[${PYTHON_USEDEP}] )
	dsmr? ( ~dev-python/dsmr-parser-1.3.1[${PYTHON_USEDEP}] )
	dunehd? ( ~dev-python/pdunehd-1.3.2[${PYTHON_USEDEP}] )
	duotecno? ( ~dev-python/pyDuotecno-2024.1.1[${PYTHON_USEDEP}] )
	...
	easyenergy? ( ~dev-python/easyenergy-2.1.0[${PYTHON_USEDEP}] )
	...
	flexit_bacnet? ( ~dev-python/flexit-bacnet-2.1.0[${PYTHON_USEDEP}] )
	...
	motionmount? ( ~dev-python/python-MotionMount-0.3.1[${PYTHON_USEDEP}] )
	...
	openai_conversation? ( ~dev-python/openai-1.3.8[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.1.0[${PYTHON_USEDEP}] )
	...
	osoenergy? ( ~dev-python/pyosoenergyapi-1.1.3[${PYTHON_USEDEP}] )
	...
	prusalink? ( ~dev-python/pyprusalink-2.0.0[${PYTHON_USEDEP}] )
	...
	qingping? ( ~dev-python/qingping-ble-0.9.0[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.8.5[${PYTHON_USEDEP}] )
	...
	schlage? ( ~dev-python/pyschlage-2023.12.1[${PYTHON_USEDEP}] )
	...
	sleepiq? ( ~dev-python/asyncsleepiq-1.4.1[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/async-upnp-client-0.38.0[${PYTHON_USEDEP}] )
	...
	sunweg? ( ~dev-python/sunweg-2.0.3[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.43.0[${PYTHON_USEDEP}] )
	switchbot_cloud? ( ~dev-python/switchbot-api-1.3.0[${PYTHON_USEDEP}] )
	...
	trafikverket_camera? ( ~dev-python/pytrafikverket-0.3.9.2[${PYTHON_USEDEP}] )
	trafikverket_ferry? ( ~dev-python/pytrafikverket-0.3.9.2[${PYTHON_USEDEP}] )
	trafikverket_train? ( ~dev-python/pytrafikverket-0.3.9.2[${PYTHON_USEDEP}] )
	trafikverket_weatherstation? ( ~dev-python/pytrafikverket-0.3.9.2[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/pyunifiprotect-4.22.5[${PYTHON_USEDEP}] ~dev-python/unifi-discovery-1.1.7[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.4.0[${PYTHON_USEDEP}] )
