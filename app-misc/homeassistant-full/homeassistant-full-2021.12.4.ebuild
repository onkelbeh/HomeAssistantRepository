...
RDEPEND="${RDEPEND}
	...
	adax? ( ~dev-python/adax-0.2.0[${PYTHON_USEDEP}] )
	...
	devolo_home_network? ( ~dev-python/devolo-plc-api-0.6.3[${PYTHON_USEDEP}] )
	...
	dlna_dmr? ( ~dev-python/async-upnp-client-0.23.1[${PYTHON_USEDEP}] )
	...
	dsmr? ( ~dev-python/dsmr-parser-0.30[${PYTHON_USEDEP}] )
	...
	elgato? ( ~dev-python/elgato-2.2.0[${PYTHON_USEDEP}] )
	...
	emulated_kasa? ( ~dev-python/sense-energy-0.9.3[${PYTHON_USEDEP}] )
	...
	ezviz? ( ~dev-python/pyEzviz-0.2.0.5[${PYTHON_USEDEP}] )
	...
	gree? ( ~dev-python/greeclimate-0.12.5[${PYTHON_USEDEP}] )
	...
	izone? ( ~dev-python/python-izone-1.1.8[${PYTHON_USEDEP}] )
	...
	launch_library? ( ~dev-python/pylaunches-1.2.0[${PYTHON_USEDEP}] )
	lcn? ( ~dev-python/pypck-0.7.10[${PYTHON_USEDEP}] )
	lg_netcast? ( ~dev-python/pylgnetcast-0.3.5[${PYTHON_USEDEP}] )
	...
	lookin? ( ~dev-python/aiolookin-0.0.4[${PYTHON_USEDEP}] )
	...
	lutron_caseta? ( ~dev-python/pylutron-caseta-0.11.0[${PYTHON_USEDEP}] ~dev-python/aiolip-1.1.6[${PYTHON_USEDEP}] )
	...
	mazda? ( ~dev-python/pymazda-0.2.2[${PYTHON_USEDEP}] )
	...
	mill? ( ~dev-python/millheater-0.9.0[${PYTHON_USEDEP}] ~dev-python/mill-local-0.1.0[${PYTHON_USEDEP}] )
	...
	motion_blinds? ( ~dev-python/motionblinds-0.5.8[${PYTHON_USEDEP}] )
	...
	nest? ( ~dev-python/python-nest-4.1.0[${PYTHON_USEDEP}] ~dev-python/google-nest-sdm-0.4.9[${PYTHON_USEDEP}] )
	netatmo? ( ~dev-python/pyatmo-6.2.0[${PYTHON_USEDEP}] )
	netdata? ( ~dev-python/netdata-1.0.1[${PYTHON_USEDEP}] )
	netgear? ( ~dev-python/pynetgear-0.8.0[${PYTHON_USEDEP}] )
	...
	nexia? ( ~dev-python/nexia-0.9.12[${PYTHON_USEDEP}] )
	...
	nissan_leaf? ( ~dev-python/pycarwings2-2.12[${PYTHON_USEDEP}] )
	...
	p1_monitor? ( ~dev-python/p1monitor-1.0.0[${PYTHON_USEDEP}] )
	...
	point? ( ~dev-python/pypoint-2.2.1[${PYTHON_USEDEP}] )
	...
	pvpc_hourly_pricing? ( ~dev-python/aiopvpc-2.2.4[${PYTHON_USEDEP}] )
	...
	rdw? ( ~dev-python/vehicle-0.2.2[${PYTHON_USEDEP}] )
	...
	renault? ( ~dev-python/renault-api-0.1.4[${PYTHON_USEDEP}] )
	...
	ridwell? ( ~dev-python/aioridwell-0.2.0[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/async-upnp-client-0.23.1[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.21.1[${PYTHON_USEDEP}] )
	...
	vesync? ( ~dev-python/pyvesync-1.4.1[${PYTHON_USEDEP}] )
