...
RDEPEND="${RDEPEND}
	...
	cloud? ( ~dev-python/hass-nabucasa-0.41.0[${PYTHON_USEDEP}] )
	...
	doods? ( ~dev-python/pydoods-1.0.2[${PYTHON_USEDEP}] ~dev-python/pillow-8.1.1[${PYTHON_USEDEP}] )
	...
	econet? ( ~dev-python/pyeconet-0.1.12[${PYTHON_USEDEP}] )
	...
	elgato? ( ~dev-python/elgato-1.0.0[${PYTHON_USEDEP}] )
	...
	hdmi_cec? ( ~dev-python/pyCEC-0.4.14[${PYTHON_USEDEP}] )
	...
	hive? ( ~dev-python/pyhiveapi-0.3.4.4[${PYTHON_USEDEP}] )
	...
	image? ( ~dev-python/pillow-8.1.1[${PYTHON_USEDEP}] )
	...
	izone? ( ~dev-python/python-izone-1.1.3[${PYTHON_USEDEP}] )
	...
	kulersky? ( ~dev-python/pykulersky-0.4.0[${PYTHON_USEDEP}] )
	...
	lastfm? ( ~dev-python/pylast-4.1.0[${PYTHON_USEDEP}] )
	...
	litterrobot? ( ~dev-python/pylitterbot-2021.2.5[${PYTHON_USEDEP}] )
	...
	lyric? ( ~dev-python/aiolyric-1.0.5[${PYTHON_USEDEP}] )
	...
	mazda? ( ~dev-python/pymazda-0.0.8[${PYTHON_USEDEP}] )
	...
	motion_blinds? ( ~dev-python/motionblinds-0.4.8[${PYTHON_USEDEP}] )
	...
	mysensors? ( ~dev-python/pymysensors-0.20.1[${PYTHON_USEDEP}] )
	...
	omnilogic? ( ~dev-python/omnilogic-0.4.2[${PYTHON_USEDEP}] )
	...
	opentherm_gw? ( ~dev-python/pyotgw-1.0_beta1[${PYTHON_USEDEP}] )
	openuv? ( ~dev-python/pyopenuv-1.0.9[${PYTHON_USEDEP}] )
	openweathermap? ( ~dev-python/pyowm-3.1.1[${PYTHON_USEDEP}] )
	...
	proxy? ( ~dev-python/pillow-8.1.1[${PYTHON_USEDEP}] )
	...
	qrcode? ( ~dev-python/pillow-8.1.1[${PYTHON_USEDEP}] ~dev-python/pyzbar-0.1.7[${PYTHON_USEDEP}] )
	...
	sendgrid? ( ~dev-python/sendgrid-6.5.0[${PYTHON_USEDEP}] )
	...
	sentry? ( ~dev-python/sentry-sdk-0.20.3[${PYTHON_USEDEP}] )
	...
	seven_segments? ( ~dev-python/pillow-8.1.1[${PYTHON_USEDEP}] )
	...
	sighthound? ( ~dev-python/pillow-8.1.1[${PYTHON_USEDEP}] ~dev-python/simplehound-0.3[${PYTHON_USEDEP}] )
	...
	smarttub? ( ~dev-python/python-smarttub-0.0.17[${PYTHON_USEDEP}] )
	...
	snapcast? ( ~dev-python/snapcast-2.1.1[${PYTHON_USEDEP}] )
	...
	ssdp? ( ~dev-python/defusedxml-0.6.0[${PYTHON_USEDEP}] ~dev-python/netdisco-2.8.2[${PYTHON_USEDEP}] ~dev-python/async-upnp-client-0.14.13[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.16.1[${PYTHON_USEDEP}] )
	...
	trend? ( ~dev-python/numpy-1.19.2[${PYTHON_USEDEP}] )
	...
	twitter? ( ~dev-python/TwitterAPI-2.6.6[${PYTHON_USEDEP}] )
	...
	verisure? ( ~dev-python/jsonpath-0.82[${PYTHON_USEDEP}] ~dev-python/vsure-1.7.2[${PYTHON_USEDEP}] )
	versasense? ( ~dev-python/pyversasense-0.0.6[${PYTHON_USEDEP}] )
	version? ( ~dev-python/pyhaversion-3.4.2[${PYTHON_USEDEP}] )
	vesync? ( ~dev-python/pyvesync-1.2.0[${PYTHON_USEDEP}] )
	...
	zwave_js? ( ~dev-python/zwave-js-server-python-0.21.0[${PYTHON_USEDEP}] )"
