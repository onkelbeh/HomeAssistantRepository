...
RDEPEND="${RDEPEND}
	...
	airzone_cloud? ( ~dev-python/aioairzone-cloud-0.3.1[${PYTHON_USEDEP}] )
	...
	dsmr? ( ~dev-python/dsmr-parser-1.3.0[${PYTHON_USEDEP}] )
	...
	nextbus? ( ~dev-python/py-nextbusnext-1.0.0[${PYTHON_USEDEP}] )
	...
	opower? ( ~dev-python/opower-0.0.38[${PYTHON_USEDEP}] )
	...
	reolink? ( ~dev-python/reolink-aio-0.7.11[${PYTHON_USEDEP}] )
	...
	yalexs_ble? ( ~dev-python/yalexs-ble-2.3.1[${PYTHON_USEDEP}] )
