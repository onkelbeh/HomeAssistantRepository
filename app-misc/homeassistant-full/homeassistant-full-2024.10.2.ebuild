...
RDEPEND="${RDEPEND}
	...
	airzone? ( ~dev-python/aioairzone-0.9.3[${PYTHON_USEDEP}] )
	...
	bluesound? ( ~dev-python/pyblu-1.0.3[${PYTHON_USEDEP}] )
	...
	duotecno? ( ~dev-python/pyDuotecno-2024.10.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-6.1.5[${PYTHON_USEDEP}] ~dev-python/ical-8.2.0[${PYTHON_USEDEP}] ~dev-python/oauth2client-4.1.3[${PYTHON_USEDEP}] )
	...
	opentherm_gw? ( ~dev-python/pyotgw-2.2.1[${PYTHON_USEDEP}] )
	...
	solarlog? ( ~dev-python/solarlog_cli-0.3.1[${PYTHON_USEDEP}] )
	...
	tibber? ( ~dev-python/pyTibber-0.30.2[${PYTHON_USEDEP}] )
