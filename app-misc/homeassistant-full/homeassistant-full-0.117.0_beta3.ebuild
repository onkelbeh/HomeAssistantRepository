...
RDEPEND="${RDEPEND}
	...
	tasmota? ( ~dev-python/HATasmota-0.0.21[${PYTHON_USEDEP}] )
	...
	tensorflow? ( ~sci-libs/tensorflow-2.3.0 ~dev-python/pycocotools-2.0.1[${PYTHON_USEDEP}] ~dev-python/numpy-1.19.2[${PYTHON_USEDEP}] ~dev-python/pillow-7.2.0[${PYTHON_USEDEP}] )
