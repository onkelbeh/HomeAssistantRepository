...
RDEPEND="${RDEPEND}
	...
	ecowitt? ( ~dev-python/aioecowitt-2022.8.3[${PYTHON_USEDEP}] )
	...
	led_ble? ( ~dev-python/led-ble-0.5.4[${PYTHON_USEDEP}] )
	...
	switchbot? ( ~dev-python/PySwitchbot-0.18.22[${PYTHON_USEDEP}] )
